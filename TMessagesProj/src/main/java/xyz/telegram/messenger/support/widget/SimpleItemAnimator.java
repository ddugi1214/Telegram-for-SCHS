...
abstract public class SimpleItemAnimator extends RecyclerView.ItemAnimator {
     ...
     * false otherwise.
     */
    abstract public boolean animateRemove(RecyclerView.ViewHolder holder);
     ...
     * false otherwise.
     */
    abstract public boolean animateAdd(RecyclerView.ViewHolder holder);
     ...
     * false otherwise.
     */
    abstract public boolean animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY,
                                        int toX, int toY);
     ...
     * false otherwise.
     */
    abstract public boolean animateChange(RecyclerView.ViewHolder oldHolder,
