 ...
 */
package xyz.telegram.messenger.exoplayer;

import xyz.telegram.messenger.exoplayer.util.Assertions;
import xyz.telegram.messenger.exoplayer.util.PriorityHandlerThread;
import xyz.telegram.messenger.exoplayer.util.TraceUtil;
...
/* package */ final class ExoPlayerImplInternal implements Handler.Callback {
  ...
  public synchronized void blockingSendMessage(ExoPlayer.ExoPlayerComponent target, int messageType,
                                               Object message) {
    if (released) {
  ...
  private <T> void sendMessageInternal(int what, Object obj)
    ...
    try {
      ...
      Pair<ExoPlayer.ExoPlayerComponent, Object> targetAndMessage = (Pair<ExoPlayer.ExoPlayerComponent, Object>) obj;
