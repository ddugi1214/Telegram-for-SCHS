 ...
 */
package xyz.telegram.messenger.exoplayer.smoothstreaming;

import xyz.telegram.messenger.exoplayer.BehindLiveWindowException;
import xyz.telegram.messenger.exoplayer.C;
import xyz.telegram.messenger.exoplayer.MediaFormat;
import xyz.telegram.messenger.exoplayer.chunk.Chunk;
import xyz.telegram.messenger.exoplayer.chunk.ChunkExtractorWrapper;
import xyz.telegram.messenger.exoplayer.chunk.ChunkOperationHolder;
import xyz.telegram.messenger.exoplayer.chunk.ChunkSource;
import xyz.telegram.messenger.exoplayer.chunk.ContainerMediaChunk;
import xyz.telegram.messenger.exoplayer.chunk.Format;
import xyz.telegram.messenger.exoplayer.chunk.FormatEvaluator;
import xyz.telegram.messenger.exoplayer.chunk.MediaChunk;
import xyz.telegram.messenger.exoplayer.drm.DrmInitData;
import xyz.telegram.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import xyz.telegram.messenger.exoplayer.extractor.mp4.Track;
import xyz.telegram.messenger.exoplayer.extractor.mp4.TrackEncryptionBox;
import xyz.telegram.messenger.exoplayer.upstream.DataSource;
import xyz.telegram.messenger.exoplayer.upstream.DataSpec;
import xyz.telegram.messenger.exoplayer.util.Assertions;
import xyz.telegram.messenger.exoplayer.util.CodecSpecificDataUtil;
import xyz.telegram.messenger.exoplayer.util.ManifestFetcher;
import xyz.telegram.messenger.exoplayer.util.MimeTypes;
...
public class SmoothStreamingChunkSource implements ChunkSource,
  ...
  private SmoothStreamingChunkSource(ManifestFetcher<SmoothStreamingManifest> manifestFetcher,
    ...
    evaluation = new FormatEvaluator.Evaluation();
    ...
    if (protectionElement != null) {
      ...
      drmInitData.put(protectionElement.uuid,
          new DrmInitData.SchemeInitData(MimeTypes.VIDEO_MP4, protectionElement.data));
    } else {
  ...
  public void continueBuffering(long playbackPositionUs) {
    ...
    if (currentManifest != newManifest && newManifest != null) {
      SmoothStreamingManifest.StreamElement currentElement = currentManifest.streamElements[enabledTrack.elementIndex];
      int currentElementChunkCount = currentElement.chunkCount;
      SmoothStreamingManifest.StreamElement newElement = newManifest.streamElements[enabledTrack.elementIndex];
  ...
  private MediaFormat initManifestTrack(SmoothStreamingManifest manifest, int elementIndex,
    ...
    int mp4TrackType;
    switch (element.type) {
      case SmoothStreamingManifest.StreamElement.TYPE_VIDEO:
        ...
        break;
      case SmoothStreamingManifest.StreamElement.TYPE_AUDIO:
        List<byte[]> csd;
        if (csdArray != null) {
        ...
        break;
      case SmoothStreamingManifest.StreamElement.TYPE_TEXT:
