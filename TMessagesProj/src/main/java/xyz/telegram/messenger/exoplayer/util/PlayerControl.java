 ...
 */
package xyz.telegram.messenger.exoplayer.util;
...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
