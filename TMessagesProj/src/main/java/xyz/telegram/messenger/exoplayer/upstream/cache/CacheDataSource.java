 ...
 */
package xyz.telegram.messenger.exoplayer.upstream.cache;

import xyz.telegram.messenger.exoplayer.C;
import xyz.telegram.messenger.exoplayer.upstream.DataSink;
import xyz.telegram.messenger.exoplayer.upstream.DataSource;
import xyz.telegram.messenger.exoplayer.upstream.DataSpec;
import xyz.telegram.messenger.exoplayer.upstream.FileDataSource;
import xyz.telegram.messenger.exoplayer.upstream.TeeDataSource;
...
public final class CacheDataSource implements DataSource {
  ...
  private void handleBeforeThrow(IOException exception) {
    if (ignoreCacheOnError && (currentDataSource == cacheReadDataSource
        || exception instanceof CacheDataSink.CacheDataSinkException)) {
