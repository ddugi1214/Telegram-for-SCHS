...
package xyz.telegram.messenger.browser;
...
import xyz.telegram.messenger.ShareBroadcastReceiver;
import xyz.telegram.messenger.support.customtabs.CustomTabsCallback;
import xyz.telegram.messenger.support.customtabs.CustomTabsClient;
import xyz.telegram.messenger.support.customtabs.CustomTabsIntent;
import xyz.telegram.messenger.support.customtabs.CustomTabsServiceConnection;
import xyz.telegram.messenger.support.customtabs.CustomTabsSession;
import xyz.telegram.messenger.support.customtabsclient.shared.CustomTabsHelper;
import xyz.telegram.messenger.support.customtabsclient.shared.ServiceConnection;
import xyz.telegram.messenger.support.customtabsclient.shared.ServiceConnectionCallback;
import xyz.telegram.ui.ActionBar.Theme;
import xyz.telegram.ui.LaunchActivity;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri) {
                ...
                builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), xyz.telegram.messenger.R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", xyz.telegram.messenger.R.string.ShareFile), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, share, 0), false);
