...
import xyz.telegram.messenger.support.widget.helper.ItemTouchHelper;
...
import xyz.telegram.ui.Cells.StickerSetCell;
...
public class StickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("Stickers", xyz.telegram.messenger.R.string.Stickers));
        ...
        private void processSelectionOption(int which, TLRPC.TL_messages_stickerSet stickerSet) {
            if (which == 0) {
                ...
                try {
                    ...
                    getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", xyz.telegram.messenger.R.string.StickersShare)), 500);
                } catch (Exception e) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    view.setBackgroundResource(xyz.telegram.messenger.R.drawable.list_selector_white);
                        ...
                        public void onClick(View v) {
                            ...
                            if (stickerSet.set.official) {
                                ...
                                items = new CharSequence[]{
                                        !stickerSet.set.disabled ? LocaleController.getString("StickersHide", xyz.telegram.messenger.R.string.StickersHide) : LocaleController.getString("StickersShow", xyz.telegram.messenger.R.string.StickersShow)
                                };
                            } else {
                                options = new int[]{0, 1, 2, 3};
                                items = new CharSequence[]{
                                        !stickerSet.set.disabled ? LocaleController.getString("StickersHide", xyz.telegram.messenger.R.string.StickersHide) : LocaleController.getString("StickersShow", xyz.telegram.messenger.R.string.StickersShow),
                                        LocaleController.getString("StickersRemove", xyz.telegram.messenger.R.string.StickersRemove),
                                        LocaleController.getString("StickersShare", xyz.telegram.messenger.R.string.StickersShare),
                                        LocaleController.getString("StickersCopy", xyz.telegram.messenger.R.string.StickersCopy),
                                };
                            }
                ...
                case 1:
                    ...
                    String text = LocaleController.getString("StickersInfo", xyz.telegram.messenger.R.string.StickersInfo);
