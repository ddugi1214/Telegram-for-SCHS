...
import xyz.telegram.messenger.BuildVars;
...
import xyz.telegram.tgnet.SerializedData;
...
import xyz.telegram.ui.Cells.TextInfoCell;
...
import xyz.telegram.ui.Cells.TextSettingsCell;
...
import xyz.telegram.ui.Components.NumberPicker;
...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureLogout", xyz.telegram.messenger.R.string.AreYouSureLogout));
        ...
        ActionBarMenuItem item = menu.addItem(0, xyz.telegram.messenger.R.drawable.ic_ab_other);
        item.addSubItem(edit_name, LocaleController.getString("EditName", xyz.telegram.messenger.R.string.EditName), 0);
        item.addSubItem(logout, LocaleController.getString("LogOut", xyz.telegram.messenger.R.string.LogOut), 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == textSizeRow) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("TextSize", xyz.telegram.messenger.R.string.TextSize));
                    final NumberPicker numberPicker = new NumberPicker(getParentActivity());
                    numberPicker.setMinValue(12);
                    numberPicker.setMaxValue(30);
                    numberPicker.setValue(MessagesController.getInstance().fontSize);
                    builder.setView(numberPicker);
                    builder.setNegativeButton(LocaleController.getString("Done", xyz.telegram.messenger.R.string.Done), new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    message.setText(Html.fromHtml(LocaleController.getString("AskAQuestionInfo", xyz.telegram.messenger.R.string.AskAQuestionInfo)));
                    ...
                    builder.setPositiveButton(LocaleController.getString("AskButton", xyz.telegram.messenger.R.string.AskButton), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            performAskAQuestion();
                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSure", xyz.telegram.messenger.R.string.AreYouSure));
                    builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Browser.openUrl(getParentActivity(), LocaleController.getString("TelegramFaqUrl", xyz.telegram.messenger.R.string.TelegramFaqUrl));
                } else if (i == privacyPolicyRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("PrivacyPolicyUrl", xyz.telegram.messenger.R.string.PrivacyPolicyUrl));
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("SortBy", xyz.telegram.messenger.R.string.SortBy));
                    builder.setItems(new CharSequence[]{
                            LocaleController.getString("Default", xyz.telegram.messenger.R.string.Default),
                            LocaleController.getString("SortFirstName", xyz.telegram.messenger.R.string.SortFirstName),
                            LocaleController.getString("SortLastName", xyz.telegram.messenger.R.string.SortLastName)
                    ...
                    for (int a = 0; a < 6; a++) {
                        ...
                        if (a == 0) {
                            ...
                            name = LocaleController.getString("AttachPhoto", xyz.telegram.messenger.R.string.AttachPhoto);
                        } else if (a == 1) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_AUDIO) != 0;
                            name = LocaleController.getString("AttachAudio", xyz.telegram.messenger.R.string.AttachAudio);
                        } else if (a == 2) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_VIDEO) != 0;
                            name = LocaleController.getString("AttachVideo", xyz.telegram.messenger.R.string.AttachVideo);
                        } else if (a == 3) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_DOCUMENT) != 0;
                            name = LocaleController.getString("AttachDocument", xyz.telegram.messenger.R.string.AttachDocument);
                        } else if (a == 4) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_MUSIC) != 0;
                            name = LocaleController.getString("AttachMusic", xyz.telegram.messenger.R.string.AttachMusic);
                        } else if (a == 5) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_GIF) != 0;
                            name = LocaleController.getString("AttachGif", xyz.telegram.messenger.R.string.AttachGif);
                        }
                        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity());
                        checkBoxCell.setTag(a);
                        checkBoxCell.setBackgroundResource(xyz.telegram.messenger.R.drawable.list_selector);
                    ...
                    cell.setTextAndIcon(LocaleController.getString("Save", xyz.telegram.messenger.R.string.Save).toUpperCase(), 0);
        ...
        shadowView.setBackgroundResource(xyz.telegram.messenger.R.drawable.header_shadow);
    ...
    private void performAskAQuestion() {
        ...
        if (supportUser == null) {
            ...
            progressDialog.setMessage(LocaleController.getString("Loading", xyz.telegram.messenger.R.string.Loading));
    ...
    private void updateUserData() {
        ...
        if (avatarImage != null) {
            ...
            onlineTextView.setText(LocaleController.getString("Online", xyz.telegram.messenger.R.string.Online));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setTextAndValue(LocaleController.getString("TextSize", xyz.telegram.messenger.R.string.TextSize), String.format("%d", size), true);
                } else if (i == languageRow) {
                    textCell.setTextAndValue(LocaleController.getString("Language", xyz.telegram.messenger.R.string.Language), LocaleController.getCurrentLanguageName(), true);
                } else if (i == contactsSortRow) {
                    String value;
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    int sort = preferences.getInt("sortContactsBy", 0);
                    if (sort == 0) {
                        value = LocaleController.getString("Default", xyz.telegram.messenger.R.string.Default);
                    } else if (sort == 1) {
                        value = LocaleController.getString("FirstName", xyz.telegram.messenger.R.string.SortFirstName);
                    } else {
                        value = LocaleController.getString("LastName", xyz.telegram.messenger.R.string.SortLastName);
                    }
                    textCell.setTextAndValue(LocaleController.getString("SortBy", xyz.telegram.messenger.R.string.SortBy), value, true);
                } else if (i == notificationRow) {
                    textCell.setText(LocaleController.getString("NotificationsAndSounds", xyz.telegram.messenger.R.string.NotificationsAndSounds), true);
                } else if (i == backgroundRow) {
                    textCell.setText(LocaleController.getString("ChatBackground", xyz.telegram.messenger.R.string.ChatBackground), true);
                } else if (i == sendLogsRow) {
                    textCell.setText("Send Logs", true);
                } else if (i == clearLogsRow) {
                    textCell.setText("Clear Logs", true);
                } else if (i == askQuestionRow) {
                    textCell.setText(LocaleController.getString("AskAQuestion", xyz.telegram.messenger.R.string.AskAQuestion), true);
                } else if (i == privacyRow) {
                    textCell.setText(LocaleController.getString("PrivacySettings", xyz.telegram.messenger.R.string.PrivacySettings), true);
                } else if (i == switchBackendButtonRow) {
                    textCell.setText("Switch Backend", true);
                } else if (i == telegramFaqRow) {
                    textCell.setText(LocaleController.getString("TelegramFAQ", xyz.telegram.messenger.R.string.TelegramFaq), true);
                } else if (i == contactsReimportRow) {
                    textCell.setText(LocaleController.getString("ImportContacts", xyz.telegram.messenger.R.string.ImportContacts), true);
                } else if (i == stickersRow) {
                    textCell.setText(LocaleController.getString("Stickers", xyz.telegram.messenger.R.string.Stickers), true);
                } else if (i == cacheRow) {
                    textCell.setText(LocaleController.getString("CacheSettings", xyz.telegram.messenger.R.string.CacheSettings), true);
                } else if (i == privacyPolicyRow) {
                    textCell.setText(LocaleController.getString("PrivacyPolicy", xyz.telegram.messenger.R.string.PrivacyPolicy), true);
                }
            } else if (type == 3) {
                if (view == null) {
                ...
                if (i == enableAnimationsRow) {
                    textCell.setTextAndCheck(LocaleController.getString("EnableAnimations", xyz.telegram.messenger.R.string.EnableAnimations), preferences.getBoolean("view_animations", true), false);
                } else if (i == sendByEnterRow) {
                    textCell.setTextAndCheck(LocaleController.getString("SendByEnter", xyz.telegram.messenger.R.string.SendByEnter), preferences.getBoolean("send_by_enter", false), false);
                } else if (i == saveToGalleryRow) {
                    textCell.setTextAndCheck(LocaleController.getString("SaveToGallerySettings", xyz.telegram.messenger.R.string.SaveToGallerySettings), MediaController.getInstance().canSaveToGallery(), false);
                } else if (i == autoplayGifsRow) {
                    textCell.setTextAndCheck(LocaleController.getString("AutoplayGifs", xyz.telegram.messenger.R.string.AutoplayGifs), MediaController.getInstance().canAutoplayGifs(), true);
                } else if (i == raiseToSpeakRow) {
                    textCell.setTextAndCheck(LocaleController.getString("RaiseToSpeak", xyz.telegram.messenger.R.string.RaiseToSpeak), MediaController.getInstance().canRaiseToSpeak(), true);
                } else if (i == customTabsRow) {
                    textCell.setTextAndValueAndCheck(LocaleController.getString("ChromeCustomTabs", xyz.telegram.messenger.R.string.ChromeCustomTabs), LocaleController.getString("ChromeCustomTabsInfo", xyz.telegram.messenger.R.string.ChromeCustomTabsInfo), MediaController.getInstance().canCustomTabs(), false, true);
                } else if (i == directShareRow) {
                    textCell.setTextAndValueAndCheck(LocaleController.getString("DirectShare", xyz.telegram.messenger.R.string.DirectShare), LocaleController.getString("DirectShareInfo", xyz.telegram.messenger.R.string.DirectShareInfo), MediaController.getInstance().canDirectShare(), false, true);
                }
            } else if (type == 4) {
                if (view == null) {
                ...
                if (i == settingsSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("SETTINGS", xyz.telegram.messenger.R.string.SETTINGS));
                } else if (i == supportSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("Support", xyz.telegram.messenger.R.string.Support));
                } else if (i == messagesSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("MessagesSettings", xyz.telegram.messenger.R.string.MessagesSettings));
                } else if (i == mediaDownloadSection2) {
                    ((HeaderCell) view).setText(LocaleController.getString("AutomaticMediaDownload", xyz.telegram.messenger.R.string.AutomaticMediaDownload));
                } else if (i == numberSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("Info", xyz.telegram.messenger.R.string.Info));
                }
            } else if (type == 5) {
                if (view == null) {
                ...
                if (i == mobileDownloadRow || i == wifiDownloadRow || i == roamingDownloadRow) {
                    ...
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    if (i == mobileDownloadRow) {
                        value = LocaleController.getString("WhenUsingMobileData", xyz.telegram.messenger.R.string.WhenUsingMobileData);
                        mask = MediaController.getInstance().mobileDataDownloadMask;
                    } else if (i == wifiDownloadRow) {
                        value = LocaleController.getString("WhenConnectedOnWiFi", xyz.telegram.messenger.R.string.WhenConnectedOnWiFi);
                        mask = MediaController.getInstance().wifiDownloadMask;
                    } else {
                        value = LocaleController.getString("WhenRoaming", xyz.telegram.messenger.R.string.WhenRoaming);
                        mask = MediaController.getInstance().roamingDownloadMask;
                    }
                    String text = "";
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_PHOTO) != 0) {
                        text += LocaleController.getString("AttachPhoto", xyz.telegram.messenger.R.string.AttachPhoto);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_AUDIO) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachAudio", xyz.telegram.messenger.R.string.AttachAudio);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_VIDEO) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachVideo", xyz.telegram.messenger.R.string.AttachVideo);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_DOCUMENT) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachDocument", xyz.telegram.messenger.R.string.AttachDocument);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_MUSIC) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachMusic", xyz.telegram.messenger.R.string.AttachMusic);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_GIF) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachGif", xyz.telegram.messenger.R.string.AttachGif);
                    }
                    if (text.length() == 0) {
                        text = LocaleController.getString("NoMediaAutoDownload", xyz.telegram.messenger.R.string.NoMediaAutoDownload);
                    }
                    ...
                    if (user != null && user.phone != null && user.phone.length() != 0) {
                        ...
                        value = LocaleController.getString("NumberUnknown", xyz.telegram.messenger.R.string.NumberUnknown);
                    }
                    textCell.setTextAndValue(value, LocaleController.getString("Phone", xyz.telegram.messenger.R.string.Phone), true);
                } else if (i == usernameRow) {
                    TLRPC.User user = UserConfig.getCurrentUser();
                    String value;
                    if (user != null && user.username != null && user.username.length() != 0) {
                        ...
                        value = LocaleController.getString("UsernameEmpty", xyz.telegram.messenger.R.string.UsernameEmpty);
                    }
                    textCell.setTextAndValue(value, LocaleController.getString("Username", xyz.telegram.messenger.R.string.Username), false);
                }
            }
            return view;
        }
