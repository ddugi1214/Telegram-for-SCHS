...
public class LanguageSelectActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("Language", xyz.telegram.messenger.R.string.Language));
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                builder.setMessage(LocaleController.getString("DeleteLocalization", xyz.telegram.messenger.R.string.DeleteLocalization));
                builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Delete", xyz.telegram.messenger.R.string.Delete), new DialogInterface.OnClickListener() {
                    @Override
