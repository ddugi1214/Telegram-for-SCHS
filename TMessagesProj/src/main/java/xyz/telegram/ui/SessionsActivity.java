...
import xyz.telegram.ui.Cells.SessionCell;
...
public class SessionsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("SessionsTitle", xyz.telegram.messenger.R.string.SessionsTitle));
        ...
        emptyLayout.setBackgroundResource(xyz.telegram.messenger.R.drawable.greydivider_bottom);
        ...
        imageView.setImageResource(xyz.telegram.messenger.R.drawable.devices);
        ...
        textView.setText(LocaleController.getString("NoOtherSessions", xyz.telegram.messenger.R.string.NoOtherSessions));
        ...
        textView.setText(LocaleController.getString("NoOtherSessionsInfo", xyz.telegram.messenger.R.string.NoOtherSessionsInfo));
        emptyLayout.addView(textView);
        layoutParams2 = (LinearLayout.LayoutParams) textView.getLayoutParams();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == terminateAllSessionsRow) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureSessions", xyz.telegram.messenger.R.string.AreYouSureSessions));
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (error == null && response instanceof TLRPC.TL_boolTrue) {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("TerminateAllSessions", xyz.telegram.messenger.R.string.TerminateAllSessions), Toast.LENGTH_SHORT);
                                                toast.show();
                                            } else {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnknownError", xyz.telegram.messenger.R.string.UnknownError), Toast.LENGTH_SHORT);
                                                toast.show();
                                            }
                                            finishFragment();
                                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("TerminateSessionQuestion", xyz.telegram.messenger.R.string.TerminateSessionQuestion));
                    builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == terminateAllSessionsRow) {
                    ...
                    textCell.setText(LocaleController.getString("TerminateAllSessions", xyz.telegram.messenger.R.string.TerminateAllSessions), false);
                }
            } else if (type == 1) {
                if (view == null) {
                ...
                if (i == terminateAllSessionsDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ClearOtherSessionsHelp", xyz.telegram.messenger.R.string.ClearOtherSessionsHelp));
                    view.setBackgroundResource(xyz.telegram.messenger.R.drawable.greydivider);
                } else if (i == otherSessionsTerminateDetail) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("TerminateSessionInfo", xyz.telegram.messenger.R.string.TerminateSessionInfo));
                ...
                if (i == currentSessionSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("CurrentSession", xyz.telegram.messenger.R.string.CurrentSession));
                } else if (i == otherSessionsSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("OtherSessions", xyz.telegram.messenger.R.string.OtherSessions));
                }
            } else if (type == 3) {
