...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (isAlwaysShare) {
            if (isGroup) {
                actionBar.setTitle(LocaleController.getString("AlwaysAllow", xyz.telegram.messenger.R.string.AlwaysAllow));
            } else {
                actionBar.setTitle(LocaleController.getString("AlwaysShareWithTitle", xyz.telegram.messenger.R.string.AlwaysShareWithTitle));
            }
        } else if (isNeverShare) {
            if (isGroup) {
                actionBar.setTitle(LocaleController.getString("NeverAllow", xyz.telegram.messenger.R.string.NeverAllow));
            } else {
                actionBar.setTitle(LocaleController.getString("NeverShareWithTitle", xyz.telegram.messenger.R.string.NeverShareWithTitle));
            }
        } else {
            actionBar.setTitle(chatType == ChatObject.CHAT_TYPE_CHAT ? LocaleController.getString("NewGroup", xyz.telegram.messenger.R.string.NewGroup) : LocaleController.getString("NewBroadcastList", xyz.telegram.messenger.R.string.NewBroadcastList));
            actionBar.setSubtitle(LocaleController.formatString("MembersCount", xyz.telegram.messenger.R.string.MembersCount, selectedContacts.size(), maxCount));
        }
        ...
        if (isAlwaysShare) {
            if (isGroup) {
                userSelectEditText.setHint(LocaleController.getString("AlwaysAllowPlaceholder", xyz.telegram.messenger.R.string.AlwaysAllowPlaceholder));
            } else {
                userSelectEditText.setHint(LocaleController.getString("AlwaysShareWithPlaceholder", xyz.telegram.messenger.R.string.AlwaysShareWithPlaceholder));
            }
        } else if (isNeverShare) {
            if (isGroup) {
                userSelectEditText.setHint(LocaleController.getString("NeverAllowPlaceholder", xyz.telegram.messenger.R.string.NeverAllowPlaceholder));
            } else {
                userSelectEditText.setHint(LocaleController.getString("NeverShareWithPlaceholder", xyz.telegram.messenger.R.string.NeverShareWithPlaceholder));
            }
        } else {
            userSelectEditText.setHint(LocaleController.getString("SendMessageTo", xyz.telegram.messenger.R.string.SendMessageTo));
        }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (selectedContacts.containsKey(user.id)) {
                    ...
                    if (chatType == ChatObject.CHAT_TYPE_CHAT && selectedContacts.size() == MessagesController.getInstance().maxGroupCount - 1) {
                        ...
                        builder.setMessage(LocaleController.getString("SoftUserLimitAlert", xyz.telegram.messenger.R.string.SoftUserLimitAlert));
