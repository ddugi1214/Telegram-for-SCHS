...
import xyz.telegram.ui.Components.PopupAudioView;
import xyz.telegram.ui.Components.RecordStatusDrawable;
import xyz.telegram.ui.Components.SizeNotifierFrameLayout;
import xyz.telegram.ui.ActionBar.Theme;
import xyz.telegram.ui.Components.TypingDotsDrawable;
...
public class PopupNotificationActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = menu.addItemResource(2, xyz.telegram.messenger.R.layout.popup_count_layout);
        countText = (TextView) view.findViewById(xyz.telegram.messenger.R.id.count_text);
    ...
    private ViewGroup getViewForMessage(int num, boolean applyOffset) {
        ...
        if (messageObject.type == 1 || messageObject.type == 4) {
            if (imageViews.size() > 0) {
                ...
                view.addView(getLayoutInflater().inflate(xyz.telegram.messenger.R.layout.popup_image_layout, null));
                view.setTag(2);
            ...
            TextView messageText = (TextView)view.findViewById(xyz.telegram.messenger.R.id.message_text);
            BackupImageView imageView = (BackupImageView) view.findViewById(xyz.telegram.messenger.R.id.message_image);
            ...
            if (audioViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                view.addView(getLayoutInflater().inflate(xyz.telegram.messenger.R.layout.popup_audio_layout, null));
                view.setTag(3);
                ...
                ViewGroup audioContainer = (ViewGroup)view.findViewById(xyz.telegram.messenger.R.id.audio_container);
            ...
            if (textViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                view.addView(getLayoutInflater().inflate(xyz.telegram.messenger.R.layout.popup_text_layout, null));
                view.setTag(1);

                View textContainer = view.findViewById(xyz.telegram.messenger.R.id.text_container);
    ...
    private void updateInterfaceForCurrentMessage(int move) {
        ...
        if (currentChat != null && currentUser != null) {
            ...
            if ((int)dialog_id == 0) {
                nameTextView.setCompoundDrawablesWithIntrinsicBounds(xyz.telegram.messenger.R.drawable.ic_lock_white, 0, 0, 0);
