...
import xyz.telegram.ui.Cells.BaseCell;
...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, MediaController.FileDownloadProgressListener {
    ...
    public PopupAudioView(Context context) {
        ...
        if (backgroundMediaDrawableIn == null) {
            backgroundMediaDrawableIn = getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_in_photo);
            statesDrawable[0][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_g);
            statesDrawable[0][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_g_s);
            statesDrawable[1][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_g);
            statesDrawable[1][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_g_s);
            statesDrawable[2][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_load);
            statesDrawable[2][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_load_s);
            statesDrawable[3][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_cancel);
            statesDrawable[3][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_cancel_s);

            statesDrawable[4][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_b);
            statesDrawable[4][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_b_s);
            statesDrawable[5][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_b);
            statesDrawable[5][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_b_s);
            statesDrawable[6][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_load);
            statesDrawable[6][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_load_s);
            statesDrawable[7][0] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_cancel);
            statesDrawable[7][1] = getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_cancel_s);
