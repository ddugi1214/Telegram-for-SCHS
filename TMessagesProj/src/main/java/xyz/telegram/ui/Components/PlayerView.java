...
import xyz.telegram.ui.AudioPlayerActivity;
...
public class PlayerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PlayerView(Context context, BaseFragment parentFragment) {
        ...
        closeButton.setImageResource(xyz.telegram.messenger.R.drawable.miniplayer_close);
    ...
    private void checkPlayer(boolean create) {
        ...
        if (messageObject == null || messageObject.getId() == 0/* || !messageObject.isMusic()*/) {
            ...
            if (MediaController.getInstance().isAudioPaused()) {
                playButton.setImageResource(xyz.telegram.messenger.R.drawable.miniplayer_play);
            } else {
                playButton.setImageResource(xyz.telegram.messenger.R.drawable.miniplayer_pause);
            }
