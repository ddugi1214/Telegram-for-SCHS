...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context) {
        ...
        mThumbDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.switch_thumb);
        if (mThumbDrawable != null) {
            mThumbDrawable.setCallback(this);
        }
        mTrackDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.switch_track);
