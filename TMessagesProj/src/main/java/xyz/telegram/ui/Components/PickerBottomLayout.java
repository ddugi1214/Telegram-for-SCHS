...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        cancelButton.setText(LocaleController.getString("Cancel", xyz.telegram.messenger.R.string.Cancel).toUpperCase());
        ...
        doneButtonBadgeTextView.setBackgroundResource(isDarkTheme ? xyz.telegram.messenger.R.drawable.photobadge : xyz.telegram.messenger.R.drawable.bluecounter);
