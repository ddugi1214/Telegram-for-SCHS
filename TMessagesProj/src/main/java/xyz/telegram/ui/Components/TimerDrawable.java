...
public class TimerDrawable extends Drawable {
    ...
    public TimerDrawable(Context context) {
        if (emptyTimerDrawable == null) {
            emptyTimerDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.header_timer);
            timerDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.header_timer2);
