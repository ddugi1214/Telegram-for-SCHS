...
import xyz.telegram.messenger.volley.AuthFailureError;
import xyz.telegram.messenger.volley.Request;
import xyz.telegram.messenger.volley.RequestQueue;
import xyz.telegram.messenger.volley.Response;
import xyz.telegram.messenger.volley.VolleyError;
import xyz.telegram.messenger.volley.toolbox.JsonObjectRequest;
import xyz.telegram.messenger.volley.toolbox.Volley;
...
import xyz.telegram.ui.Cells.PhotoPickerPhotoCell;
...
public class PhotoPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        if (selectedAlbum != null) {
            ...
            actionBar.setTitle(LocaleController.getString("SearchImagesTitle", xyz.telegram.messenger.R.string.SearchImagesTitle));
        } else if (type == 1) {
            actionBar.setTitle(LocaleController.getString("SearchGifsTitle", xyz.telegram.messenger.R.string.SearchGifsTitle));
        }
            ...
            searchItem = menu.addItem(0, xyz.telegram.messenger.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
                ...
                public void onTextChanged(EditText editText) {
                    if (editText.getText().length() == 0) {
                        ...
                        requestQueue.cancelAll("search");
                        if (type == 0) {
                            emptyView.setText(LocaleController.getString("NoRecentPhotos", xyz.telegram.messenger.R.string.NoRecentPhotos));
                        } else if (type == 1) {
                            emptyView.setText(LocaleController.getString("NoRecentGIFs", xyz.telegram.messenger.R.string.NoRecentGIFs));
                        }
                ...
                public void onSearchPressed(EditText editText) {
                    ...
                    if (lastSearchString.length() == 0) {
                        ...
                        emptyView.setText(LocaleController.getString("NoResult", xyz.telegram.messenger.R.string.NoResult));
                    }
                    updateSearchInterface();
                }
            });
        ...
        if (selectedAlbum == null) {
            if (type == 0) {
                searchItem.getSearchField().setHint(LocaleController.getString("SearchImagesTitle", xyz.telegram.messenger.R.string.SearchImagesTitle));
            } else if (type == 1) {
                searchItem.getSearchField().setHint(LocaleController.getString("SearchGifsTitle", xyz.telegram.messenger.R.string.SearchGifsTitle));
            }
        }
        ...
        listView.setSelector(xyz.telegram.messenger.R.drawable.list_selector);
        ...
        if (selectedAlbum != null) {
            emptyView.setText(LocaleController.getString("NoPhotos", xyz.telegram.messenger.R.string.NoPhotos));
        } else {
            if (type == 0) {
                emptyView.setText(LocaleController.getString("NoRecentPhotos", xyz.telegram.messenger.R.string.NoRecentPhotos));
            } else if (type == 1) {
        ...
        if (cell != null) {
            if (selectedAlbum != null) {
                ...
                if (photoEntry.thumbPath != null) {
                    cell.photoImage.setImage(photoEntry.thumbPath, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                } else if (photoEntry.path != null) {
                    cell.photoImage.setOrientation(photoEntry.orientation, true);
                    if (photoEntry.isVideo) {
                        cell.photoImage.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                    } else {
                        cell.photoImage.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                    }
                } else {
                    cell.photoImage.setImageResource(xyz.telegram.messenger.R.drawable.nophotos);
                }
            } else {
                ArrayList<MediaController.SearchImage> array;
                if (searchResult.isEmpty() && lastSearchString == null) {
                ...
                if (photoEntry.document != null && photoEntry.document.thumb != null) {
                    cell.photoImage.setImage(photoEntry.document.thumb.location, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                } else if (photoEntry.thumbPath != null) {
                    cell.photoImage.setImage(photoEntry.thumbPath, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                } else if (photoEntry.thumbUrl != null && photoEntry.thumbUrl.length() > 0) {
                    cell.photoImage.setImage(photoEntry.thumbUrl, null, cell.getContext().getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                } else {
                    cell.photoImage.setImageResource(xyz.telegram.messenger.R.drawable.nophotos);
                }
            }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (viewType == 0) {
                ...
                if (selectedAlbum != null) {
                    ...
                    if (photoEntry.thumbPath != null) {
                        imageView.setImage(photoEntry.thumbPath, null, mContext.getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                    } else if (photoEntry.path != null) {
                        imageView.setOrientation(photoEntry.orientation, true);
                        if (photoEntry.isVideo) {
                            imageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, mContext.getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                        } else {
                            imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, mContext.getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                        }
                    } else {
                        imageView.setImageResource(xyz.telegram.messenger.R.drawable.nophotos);
                    }
                    ...
                    if (photoEntry.thumbPath != null) {
                        ...
                        imageView.setImage(photoEntry.thumbUrl, null, mContext.getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                    } else if (photoEntry.document != null && photoEntry.document.thumb != null) {
                        imageView.setImage(photoEntry.document.thumb.location, null, mContext.getResources().getDrawable(xyz.telegram.messenger.R.drawable.nophotos));
                    } else {
                        imageView.setImageResource(xyz.telegram.messenger.R.drawable.nophotos);
                    }
                ...
                if (view == null) {
                    ...
                    view = li.inflate(xyz.telegram.messenger.R.layout.media_loading_layout, viewGroup, false);
                }
