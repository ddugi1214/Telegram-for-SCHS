...
import xyz.telegram.ui.Cells.BotSwitchCell;
import xyz.telegram.ui.Cells.ContextLinkCell;
import xyz.telegram.ui.Cells.MentionCell;
                                            ...
                                            if (user.bot && user.bot_inline_placeholder != null) {
                                                ...
                                                if (foundContextBot.bot_inline_geo) {
                                                    ...
                                                    if (!allowGeo && parentFragment != null && parentFragment.getParentActivity() != null) {
                                                        ...
                                                        builder.setMessage(LocaleController.getString("ShareYouLocationInline", xyz.telegram.messenger.R.string.ShareYouLocationInline));
                                                        ...
                                                        builder.setNegativeButton(LocaleController.getString("Cancel", xyz.telegram.messenger.R.string.Cancel), new DialogInterface.OnClickListener() {
                                                            @Override
