...
import xyz.telegram.ui.Cells.LetterSectionCell;
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 4) {
            ...
            if (convertView == null) {
                ...
                ((GreySectionCell) convertView).setText(LocaleController.getString("Contacts", xyz.telegram.messenger.R.string.Contacts).toUpperCase());
            }
        } else if (type == 2) {
            if (convertView == null) {
            ...
            if (needPhonebook) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("InviteToGroupByLink", xyz.telegram.messenger.R.string.InviteToGroupByLink), xyz.telegram.messenger.R.drawable.menu_invite);
            } else {
                if (position == 0) {
