...
public class AudioCell extends FrameLayout {
            ...
            public void onClick(View v) {
                if (audioEntry != null) {
                    if (MediaController.getInstance().isPlayingAudio(audioEntry.messageObject) && !MediaController.getInstance().isAudioPaused()) {
                        ...
                        playButton.setImageResource(xyz.telegram.messenger.R.drawable.audiosend_play);
                    } else {
                        ...
                        if (MediaController.getInstance().setPlaylist(arrayList, audioEntry.messageObject)) {
                            playButton.setImageResource(xyz.telegram.messenger.R.drawable.audiosend_pause);
                            if (delegate != null) {
    ...
    public void setAudio(MediaController.AudioEntry entry, boolean divider, boolean checked) {
        ...
        playButton.setImageResource(MediaController.getInstance().isPlayingAudio(audioEntry.messageObject) && !MediaController.getInstance().isAudioPaused() ? xyz.telegram.messenger.R.drawable.audiosend_pause : xyz.telegram.messenger.R.drawable.audiosend_play);
