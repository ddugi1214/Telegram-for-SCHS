...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            lockDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.list_secret);
            checkDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.dialogs_check);
            halfCheckDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.dialogs_halfcheck);
            clockDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_clock);
            errorDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.dialogs_warning);
            countDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.dialogs_badge);
            countDrawableGrey = getResources().getDrawable(xyz.telegram.messenger.R.drawable.dialogs_badge2);
            groupDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.list_group);
            broadcastDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.list_broadcast);
            muteDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.mute_grey);
            verifiedDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.check_list);
            botDrawable = getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_list);
        }

        setBackgroundResource(xyz.telegram.messenger.R.drawable.list_selector);
    ...
    public void buildLayout() {
        ...
        if (printingString != null) {
            ...
            if (draftMessage != null) {
                ...
                if (TextUtils.isEmpty(draftMessage.message)) {
                    String draftString = LocaleController.getString("Draft", xyz.telegram.messenger.R.string.Draft);
                ...
                if (message == null) {
                    if (encryptedChat != null) {
                        ...
                        if (encryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
                            messageString = LocaleController.getString("EncryptionProcessing", xyz.telegram.messenger.R.string.EncryptionProcessing);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
                            if (user != null && user.first_name != null) {
                                messageString = LocaleController.formatString("AwaitingEncryption", xyz.telegram.messenger.R.string.AwaitingEncryption, user.first_name);
                            } else {
                                messageString = LocaleController.formatString("AwaitingEncryption", xyz.telegram.messenger.R.string.AwaitingEncryption, "");
                            }
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
                            messageString = LocaleController.getString("EncryptionRejected", xyz.telegram.messenger.R.string.EncryptionRejected);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
                            if (encryptedChat.admin_id == UserConfig.getClientUserId()) {
                                if (user != null && user.first_name != null) {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", xyz.telegram.messenger.R.string.EncryptedChatStartedOutgoing, user.first_name);
                                } else {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", xyz.telegram.messenger.R.string.EncryptedChatStartedOutgoing, "");
                                }
                            } else {
                                messageString = LocaleController.getString("EncryptedChatStartedIncoming", xyz.telegram.messenger.R.string.EncryptedChatStartedIncoming);
                            }
                        }
                    }
                } else {
                    ...
                    if (message.messageOwner instanceof TLRPC.TL_messageService) {
                        ...
                        if (chat != null && chat.id > 0 && fromChat == null) {
                            ...
                            if (message.isOutOwner()) {
                                name = LocaleController.getString("FromYou", xyz.telegram.messenger.R.string.FromYou);
        ...
        if (nameString.length() == 0) {
            nameString = LocaleController.getString("HiddenName", xyz.telegram.messenger.R.string.HiddenName);
        }
