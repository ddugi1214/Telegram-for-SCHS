...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    public PhotoPickerSearchCell(Context context, boolean allowGifs) {
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchImages", xyz.telegram.messenger.R.string.SearchImages));
        searchButton.textView2.setText(LocaleController.getString("SearchImagesInfo", xyz.telegram.messenger.R.string.SearchImagesInfo));
        searchButton.imageView.setImageResource(xyz.telegram.messenger.R.drawable.search_web);
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchGifs", xyz.telegram.messenger.R.string.SearchGifs));
        searchButton.textView2.setText("GIPHY");
        searchButton.imageView.setImageResource(xyz.telegram.messenger.R.drawable.search_gif);
        addView(searchButton);
