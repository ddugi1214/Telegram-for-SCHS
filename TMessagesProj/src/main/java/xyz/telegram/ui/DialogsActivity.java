...
import xyz.telegram.messenger.DialogObject;
...
import xyz.telegram.ui.Adapters.DialogsAdapter;
import xyz.telegram.ui.Adapters.DialogsSearchAdapter;
import xyz.telegram.ui.Cells.HintDialogCell;
import xyz.telegram.ui.Cells.ProfileSearchCell;
import xyz.telegram.ui.Cells.UserCell;
import xyz.telegram.ui.Cells.DialogCell;
...
import xyz.telegram.ui.ActionBar.MenuDrawable;
import xyz.telegram.ui.Components.PlayerView;
import xyz.telegram.ui.Components.EmptyTextProgressView;
...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        if (!onlySelect && searchString == null) {
            passcodeItem = menu.addItem(1, xyz.telegram.messenger.R.drawable.lock_close);
            updatePasscodeButton();
        }
        final ActionBarMenuItem item = menu.addItem(0, xyz.telegram.messenger.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            @Override
        ...
        item.getSearchField().setHint(LocaleController.getString("Search", xyz.telegram.messenger.R.string.Search));
        if (onlySelect) {
            actionBar.setBackButtonImage(xyz.telegram.messenger.R.drawable.ic_ab_back);
            actionBar.setTitle(LocaleController.getString("SelectChat", xyz.telegram.messenger.R.string.SelectChat));
        } else {
            if (searchString != null) {
                actionBar.setBackButtonImage(xyz.telegram.messenger.R.drawable.ic_ab_back);
            } else {
            ...
            if (BuildVars.DEBUG_VERSION) {
                actionBar.setTitle(LocaleController.getString("AppNameBeta", xyz.telegram.messenger.R.string.AppNameBeta));
            } else {
            ...
            public boolean onItemClick(View view, int position) {
                ...
                if (DialogObject.isChannel(dialog)) {
                    ...
                    if (chat != null && chat.megagroup) {
                        items = new CharSequence[]{LocaleController.getString("ClearHistoryCache", xyz.telegram.messenger.R.string.ClearHistoryCache), chat == null || !chat.creator ? LocaleController.getString("LeaveMegaMenu", xyz.telegram.messenger.R.string.LeaveMegaMenu) : LocaleController.getString("DeleteMegaMenu", xyz.telegram.messenger.R.string.DeleteMegaMenu)};
                    } else {
                        items = new CharSequence[]{LocaleController.getString("ClearHistoryCache", xyz.telegram.messenger.R.string.ClearHistoryCache), chat == null || !chat.creator ? LocaleController.getString("LeaveChannelMenu", xyz.telegram.messenger.R.string.LeaveChannelMenu) : LocaleController.getString("ChannelDeleteMenu", xyz.telegram.messenger.R.string.ChannelDeleteMenu)};
                    }
                    builder.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, final int which) {
                            ...
                            if (which == 0) {
                                if (chat != null && chat.megagroup) {
                                    builder.setMessage(LocaleController.getString("AreYouSureClearHistorySuper", xyz.telegram.messenger.R.string.AreYouSureClearHistorySuper));
                                } else {
                                    builder.setMessage(LocaleController.getString("AreYouSureClearHistoryChannel", xyz.telegram.messenger.R.string.AreYouSureClearHistoryChannel));
                                }
                                ...
                                if (chat != null && chat.megagroup) {
                                    if (!chat.creator) {
                                        builder.setMessage(LocaleController.getString("MegaLeaveAlert", xyz.telegram.messenger.R.string.MegaLeaveAlert));
                                    } else {
                                        builder.setMessage(LocaleController.getString("MegaDeleteAlert", xyz.telegram.messenger.R.string.MegaDeleteAlert));
                                    }
                                } else {
                                    if (chat == null || !chat.creator) {
                                        builder.setMessage(LocaleController.getString("ChannelLeaveAlert", xyz.telegram.messenger.R.string.ChannelLeaveAlert));
                                    } else {
                                        builder.setMessage(LocaleController.getString("ChannelDeleteAlert", xyz.telegram.messenger.R.string.ChannelDeleteAlert));
                                    }
                                }
                                builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                                    @Override
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("ClearHistory", xyz.telegram.messenger.R.string.ClearHistory),
                            isChat ? LocaleController.getString("DeleteChat", xyz.telegram.messenger.R.string.DeleteChat) :
                                    isBot ? LocaleController.getString("DeleteAndStop", xyz.telegram.messenger.R.string.DeleteAndStop) : LocaleController.getString("Delete", xyz.telegram.messenger.R.string.Delete)}, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, final int which) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
        ...
        searchEmptyView.setText(LocaleController.getString("NoResult", xyz.telegram.messenger.R.string.NoResult));
        ...
        textView.setText(LocaleController.getString("NoChats", xyz.telegram.messenger.R.string.NoChats));
        ...
        String help = LocaleController.getString("NoChatsHelp", xyz.telegram.messenger.R.string.NoChatsHelp);
        ...
        floatingButton.setBackgroundResource(xyz.telegram.messenger.R.drawable.floating_states);
        floatingButton.setImageResource(xyz.telegram.messenger.R.drawable.floating_pencil);
        ...
        dialogsSearchAdapter.setDelegate(new DialogsSearchAdapter.DialogsSearchAdapterDelegate() {
            ...
            public void needRemoveHint(final int did) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                builder.setMessage(LocaleController.formatString("ChatHintsDelete", xyz.telegram.messenger.R.string.ChatHintsDelete, ContactsController.formatName(user.first_name, user.last_name)));
                builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (activity != null) {
                ...
                if (activity.checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED || activity.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (activity.shouldShowRequestPermissionRationale(Manifest.permission.READ_CONTACTS)) {
                        ...
                        builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                        builder.setMessage(LocaleController.getString("PermissionContacts", xyz.telegram.messenger.R.string.PermissionContacts));
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                        builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                        builder.setMessage(LocaleController.getString("PermissionStorage", xyz.telegram.messenger.R.string.PermissionStorage));
                        builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), null);
                        showDialog(permissionDialog = builder.create());
                    } else {
                        askForPermissons();
    ...
    private void updatePasscodeButton() {
        ...
        if (UserConfig.passcodeHash.length() != 0 && !searching) {
            ...
            if (UserConfig.appLocked) {
                passcodeItem.setIcon(xyz.telegram.messenger.R.drawable.lock_close);
            } else {
                passcodeItem.setIcon(xyz.telegram.messenger.R.drawable.lock_open);
            }
        } else {
    ...
    private void didSelectResult(final long dialog_id, boolean useAlert, final boolean param) {
        if (addToGroupAlertString == null) {
            if ((int) dialog_id < 0 && ChatObject.isChannel(-(int) dialog_id) && !ChatObject.isCanWriteToChannel(-(int) dialog_id)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                builder.setMessage(LocaleController.getString("ChannelCantSendMessage", xyz.telegram.messenger.R.string.ChannelCantSendMessage));
                builder.setNegativeButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), null);
                showDialog(builder.create());
                return;
            }
        }
