...
import xyz.telegram.messenger.query.SharedMediaQuery;
...
import xyz.telegram.ui.Cells.AboutLinkCell;
import xyz.telegram.ui.Cells.DividerCell;
import xyz.telegram.ui.Cells.EmptyCell;
import xyz.telegram.ui.Cells.LoadingCell;
import xyz.telegram.ui.Cells.ShadowSectionCell;
import xyz.telegram.ui.Cells.TextCell;
import xyz.telegram.ui.Cells.TextDetailCell;
import xyz.telegram.ui.Cells.TextInfoPrivacyCell;
import xyz.telegram.ui.Cells.UserCell;
...
import xyz.telegram.ui.Components.AvatarDrawable;
import xyz.telegram.ui.Components.AvatarUpdater;
import xyz.telegram.ui.Components.BackupImageView;
import xyz.telegram.ui.ActionBar.BaseFragment;
import xyz.telegram.ui.Components.IdenticonDrawable;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
            ...
            public void onItemClick(final int id) {
                ...
                if (id == -1) {
                    ...
                    if (!user.bot) {
                        ...
                        if (!userBlocked) {
                            builder.setMessage(LocaleController.getString("AreYouSureBlockContact", xyz.telegram.messenger.R.string.AreYouSureBlockContact));
                        } else {
                    ...
                    args.putString("selectAlertString", LocaleController.getString("SendContactTo", xyz.telegram.messenger.R.string.SendContactTo));
                    args.putString("selectAlertStringGroup", LocaleController.getString("SendContactToGroup", xyz.telegram.messenger.R.string.SendContactToGroup));
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSureDeleteContact", xyz.telegram.messenger.R.string.AreYouSureDeleteContact));
                    builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupTitle", xyz.telegram.messenger.R.string.AddToTheGroupTitle, UserObject.getUserName(user), "%1$s"));
                    DialogsActivity fragment = new DialogsActivity(args);
                    ...
                    try {
                        ...
                        startActivityForResult(Intent.createChooser(intent, LocaleController.getString("BotShare", xyz.telegram.messenger.R.string.BotShare)), 500);
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                if (position == sharedMediaRow) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSureSecretChat", xyz.telegram.messenger.R.string.AreYouSureSecretChat));
                    builder.setTitle(LocaleController.getString("AppName", xyz.telegram.messenger.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    try {
                        ...
                        getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("BotShare", xyz.telegram.messenger.R.string.BotShare)), 500);
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("ConvertGroupAlert", xyz.telegram.messenger.R.string.ConvertGroupAlert));
                    builder.setTitle(LocaleController.getString("ConvertGroupAlertWarning", xyz.telegram.messenger.R.string.ConvertGroupAlertWarning));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.telegram.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            public boolean onItemClick(View view, int position) {
                if (position > emptyRowChat2 && position < membersEndRow) {
                    ...
                    if (currentChat.megagroup && currentChat.creator && allowSetAdmin) {
                        CharSequence[] items = new CharSequence[]{LocaleController.getString("SetAsAdmin", xyz.telegram.messenger.R.string.SetAsAdmin), LocaleController.getString("KickFromGroup", xyz.telegram.messenger.R.string.KickFromGroup)};
                        ...
                        CharSequence[] items = new CharSequence[]{chat_id > 0 ? LocaleController.getString("KickFromGroup", xyz.telegram.messenger.R.string.KickFromGroup) : LocaleController.getString("KickFromBroadcast", xyz.telegram.messenger.R.string.KickFromBroadcast)};
                        builder.setItems(items, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (i == 0) {
        ...
        if (user_id != 0 || chat_id >= 0 && !ChatObject.isLeftFromChat(currentChat)) {
            ...
            try {
                writeButton.setBackgroundResource(xyz.telegram.messenger.R.drawable.floating_user_states);
            } catch (Throwable e) {
                FileLog.e("tmessages", e);
            }
            writeButton.setScaleType(ImageView.ScaleType.CENTER);
            if (user_id != 0) {
                writeButton.setImageResource(xyz.telegram.messenger.R.drawable.floating_message);
                ...
                if (isChannel && !currentChat.creator && (!currentChat.megagroup || !currentChat.editor) || !isChannel && !currentChat.admin && !currentChat.creator && currentChat.admins_enabled) {
                    ...
                    writeButton.setImageResource(xyz.telegram.messenger.R.drawable.floating_camera);
                }
            }
                    ...
                    if (user_id != 0) {
                        ...
                        if (isChannel && !currentChat.creator && (!currentChat.megagroup || !currentChat.editor) || !isChannel && !currentChat.admin && !currentChat.creator && currentChat.admins_enabled) {
                            ...
                            if (chat.photo == null || chat.photo.photo_big == null || chat.photo instanceof TLRPC.TL_chatPhotoEmpty) {
                                items = new CharSequence[]{LocaleController.getString("FromCamera", xyz.telegram.messenger.R.string.FromCamera), LocaleController.getString("FromGalley", xyz.telegram.messenger.R.string.FromGalley)};
                            } else {
                                items = new CharSequence[]{LocaleController.getString("FromCamera", xyz.telegram.messenger.R.string.FromCamera), LocaleController.getString("FromGalley", xyz.telegram.messenger.R.string.FromGalley), LocaleController.getString("DeletePhoto", xyz.telegram.messenger.R.string.DeletePhoto)};
                            }
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setItems(new CharSequence[]{LocaleController.getString("Copy", xyz.telegram.messenger.R.string.Copy)}, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setItems(new CharSequence[]{LocaleController.getString("Call", xyz.telegram.messenger.R.string.Call), LocaleController.getString("Copy", xyz.telegram.messenger.R.string.Copy)}, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        try {
    ...
    private void leaveChatPressed() {
        ...
        if (ChatObject.isChannel(chat_id) && !currentChat.megagroup) {
            builder.setMessage(ChatObject.isChannel(chat_id) ? LocaleController.getString("ChannelLeaveAlert", xyz.telegram.messenger.R.string.ChannelLeaveAlert) : LocaleController.getString("AreYouSureDeleteAndExit", xyz.telegram.messenger.R.string.AreYouSureDeleteAndExit));
        } else {
    ...
    private void openAddMember() {
        ...
        if (chat_id > 0) {
            ...
            args.putString("selectAlertString", LocaleController.getString("AddToTheGroup", xyz.telegram.messenger.R.string.AddToTheGroup));
        }
        ...
        if (playProfileAnimation && allowProfileAnimation) {
            ...
            if (menu.getItem(10) == null) {
                if (animatingItem == null) {
                    animatingItem = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                }
            }
            if (isOpen) {
    ...
    private void updateProfileData() {
        ...
        if (user_id != 0) {
            ...
            if (user.id == 333000 || user.id == 777000) {
                newString2 = LocaleController.getString("ServiceNotifications", xyz.telegram.messenger.R.string.ServiceNotifications);
            } else if (user.bot) {
                newString2 = LocaleController.getString("Bot", xyz.telegram.messenger.R.string.Bot);
            } else {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                int leftIcon = currentEncryptedChat != null ? xyz.telegram.messenger.R.drawable.ic_lock_header : 0;
                int rightIcon = 0;
                if (a == 0) {
                    rightIcon = MessagesController.getInstance().isDialogMuted(dialog_id != 0 ? dialog_id : (long) user_id) ? xyz.telegram.messenger.R.drawable.mute_fixed : 0;
                } else if (user.verified) {
                    rightIcon = xyz.telegram.messenger.R.drawable.check_profile_fixed;
                }
            ...
            if (ChatObject.isChannel(chat)) {
                if (info == null || !currentChat.megagroup && (info.participants_count == 0 || (currentChat.admin || info.can_view_participants))) {
                    if (currentChat.megagroup) {
                        newString = LocaleController.getString("Loading", xyz.telegram.messenger.R.string.Loading).toLowerCase();
                    } else {
                        if ((chat.flags & TLRPC.CHAT_FLAG_IS_PUBLIC) != 0) {
                            newString = LocaleController.getString("ChannelPublic", xyz.telegram.messenger.R.string.ChannelPublic).toLowerCase();
                        } else {
                            newString = LocaleController.getString("ChannelPrivate", xyz.telegram.messenger.R.string.ChannelPrivate).toLowerCase();
                        }
                    }
                } else {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                if (a != 0) {
                    if (chat.verified) {
                        nameTextView[a].setRightDrawable(xyz.telegram.messenger.R.drawable.check_profile_fixed);
                    } else {
                        nameTextView[a].setRightDrawable(null);
                    }
                } else {
                    nameTextView[a].setRightDrawable(MessagesController.getInstance().isDialogMuted((long) -chat_id) ? xyz.telegram.messenger.R.drawable.mute_fixed : 0);
                }
    ...
    private void createActionBarMenu() {
        ...
        if (user_id != 0) {
            if (ContactsController.getInstance().contactsDict.get(user_id) == null) {
                ...
                item = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                if (user.bot) {
                    if (!user.bot_nochats) {
                        item.addSubItem(invite_to_group, LocaleController.getString("BotInvite", xyz.telegram.messenger.R.string.BotInvite), 0);
                    }
                    item.addSubItem(share, LocaleController.getString("BotShare", xyz.telegram.messenger.R.string.BotShare), 0);
                }
                if (user.phone != null && user.phone.length() != 0) {
                    item.addSubItem(add_contact, LocaleController.getString("AddContact", xyz.telegram.messenger.R.string.AddContact), 0);
                    item.addSubItem(share_contact, LocaleController.getString("ShareContact", xyz.telegram.messenger.R.string.ShareContact), 0);
                    item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", xyz.telegram.messenger.R.string.BlockContact) : LocaleController.getString("Unblock", xyz.telegram.messenger.R.string.Unblock), 0);
                } else {
                    if (user.bot) {
                        item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BotStop", xyz.telegram.messenger.R.string.BotStop) : LocaleController.getString("BotRestart", xyz.telegram.messenger.R.string.BotRestart), 0);
                    } else {
                        item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", xyz.telegram.messenger.R.string.BlockContact) : LocaleController.getString("Unblock", xyz.telegram.messenger.R.string.Unblock), 0);
                    }
                }
                ...
                item.addSubItem(share_contact, LocaleController.getString("ShareContact", xyz.telegram.messenger.R.string.ShareContact), 0);
                item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", xyz.telegram.messenger.R.string.BlockContact) : LocaleController.getString("Unblock", xyz.telegram.messenger.R.string.Unblock), 0);
                item.addSubItem(edit_contact, LocaleController.getString("EditContact", xyz.telegram.messenger.R.string.EditContact), 0);
                item.addSubItem(delete_contact, LocaleController.getString("DeleteContact", xyz.telegram.messenger.R.string.DeleteContact), 0);
            }
        } else if (chat_id != 0) {
            if (chat_id > 0) {
                TLRPC.Chat chat = MessagesController.getInstance().getChat(chat_id);
                ...
                if (ChatObject.isChannel(chat)) {
                    if (chat.creator || chat.megagroup && chat.editor) {
                        item = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                        item.addSubItem(edit_channel, LocaleController.getString("ChannelEdit", xyz.telegram.messenger.R.string.ChannelEdit), 0);
                    }
                    if (!chat.creator && !chat.left && !chat.kicked && chat.megagroup) {
                        if (item == null) {
                            item = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                        }
                        item.addSubItem(leave_group, LocaleController.getString("LeaveMegaMenu", xyz.telegram.messenger.R.string.LeaveMegaMenu), 0);
                    }
                } else {
                    item = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                    if (chat.creator && chat_id > 0) {
                        item.addSubItem(set_admins, LocaleController.getString("SetAdmins", xyz.telegram.messenger.R.string.SetAdmins), 0);
                    }
                    if (!chat.admins_enabled || chat.creator || chat.admin) {
                        item.addSubItem(edit_name, LocaleController.getString("EditName", xyz.telegram.messenger.R.string.EditName), 0);
                    }
                    if (chat.creator && (info == null || info.participants.participants.size() > 1)) {
                        item.addSubItem(convert_to_supergroup, LocaleController.getString("ConvertGroupMenu", xyz.telegram.messenger.R.string.ConvertGroupMenu), 0);
                    }
                    item.addSubItem(leave_group, LocaleController.getString("DeleteAndExit", xyz.telegram.messenger.R.string.DeleteAndExit), 0);
                }
            } else {
                item = menu.addItem(10, xyz.telegram.messenger.R.drawable.ic_ab_other);
                item.addSubItem(edit_name, LocaleController.getString("EditName", xyz.telegram.messenger.R.string.EditName), 0);
        ...
        item.addSubItem(add_shortcut, LocaleController.getString("AddShortcut", xyz.telegram.messenger.R.string.AddShortcut), 0);
    }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 6:
                    ...
                    cell.setBackgroundResource(xyz.telegram.messenger.R.drawable.greydivider);
                    cell.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ConvertGroupInfo", xyz.telegram.messenger.R.string.ConvertGroupInfo, LocaleController.formatPluralString("Members", MessagesController.getInstance().maxMegagroupCount))));
                    break;
                case 7:
                ...
                case 2:
                    ...
                    if (i == phoneRow) {
                        ...
                        if (user.phone != null && user.phone.length() != 0) {
                            ...
                            text = LocaleController.getString("NumberUnknown", xyz.telegram.messenger.R.string.NumberUnknown);
                        }
                        textDetailCell.setTextAndValueAndIcon(text, LocaleController.getString("PhoneMobile", xyz.telegram.messenger.R.string.PhoneMobile), xyz.telegram.messenger.R.drawable.phone_grey);
                        ...
                        textDetailCell.setTextAndValue(text, LocaleController.getString("Username", xyz.telegram.messenger.R.string.Username));
                ...
                case 3:
                    ...
                    if (i == sharedMediaRow) {
                        ...
                        if (totalMediaCount == -1) {
                            value = LocaleController.getString("Loading", xyz.telegram.messenger.R.string.Loading);
                        } else {
                            value = String.format("%d", totalMediaCount + (totalMediaCountMerge != -1 ? totalMediaCountMerge : 0));
                        }
                        textCell.setTextAndValue(LocaleController.getString("SharedMedia", xyz.telegram.messenger.R.string.SharedMedia), value);
                    } else if (i == settingsTimerRow) {
                        TLRPC.EncryptedChat encryptedChat = MessagesController.getInstance().getEncryptedChat((int)(dialog_id >> 32));
                        String value;
                        if (encryptedChat.ttl == 0) {
                            value = LocaleController.getString("ShortMessageLifetimeForever", xyz.telegram.messenger.R.string.ShortMessageLifetimeForever);
                        } else {
                            value = AndroidUtilities.formatTTLString(encryptedChat.ttl);
                        }
                        textCell.setTextAndValue(LocaleController.getString("MessageLifetime", xyz.telegram.messenger.R.string.MessageLifetime), value);
                    } else if (i == settingsNotificationsRow) {
                        textCell.setTextAndIcon(LocaleController.getString("NotificationsAndSounds", xyz.telegram.messenger.R.string.NotificationsAndSounds), xyz.telegram.messenger.R.drawable.profile_list);
                    } else if (i == startSecretChatRow) {
                        textCell.setText(LocaleController.getString("StartEncryptedChat", xyz.telegram.messenger.R.string.StartEncryptedChat));
                        textCell.setTextColor(0xff37a919);
                    } else if (i == settingsKeyRow) {
                        IdenticonDrawable identiconDrawable = new IdenticonDrawable();
                        TLRPC.EncryptedChat encryptedChat = MessagesController.getInstance().getEncryptedChat((int)(dialog_id >> 32));
                        identiconDrawable.setEncryptedChat(encryptedChat);
                        textCell.setTextAndValueDrawable(LocaleController.getString("EncryptionKey", xyz.telegram.messenger.R.string.EncryptionKey), identiconDrawable);
                    } else if (i == leaveChannelRow) {
                        textCell.setTextColor(0xffed3d39);
                        textCell.setText(LocaleController.getString("LeaveChannel", xyz.telegram.messenger.R.string.LeaveChannel));
                    } else if (i == convertRow) {
                        textCell.setText(LocaleController.getString("UpgradeGroup", xyz.telegram.messenger.R.string.UpgradeGroup));
                        textCell.setTextColor(0xff37a919);
                    } else if (i == membersRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelMembers", xyz.telegram.messenger.R.string.ChannelMembers), String.format("%d", info.participants_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelMembers", xyz.telegram.messenger.R.string.ChannelMembers));
                        }
                    } else if (i == managementRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelAdministrators", xyz.telegram.messenger.R.string.ChannelAdministrators), String.format("%d", info.admins_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelAdministrators", xyz.telegram.messenger.R.string.ChannelAdministrators));
                        }
                    } else if (i == blockedUsersRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelBlockedUsers", xyz.telegram.messenger.R.string.ChannelBlockedUsers), String.format("%d", info.kicked_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelBlockedUsers", xyz.telegram.messenger.R.string.ChannelBlockedUsers));
                        }
                    } else if (i == addMemberRow) {
                        if (chat_id > 0) {
                            textCell.setText(LocaleController.getString("AddMember", xyz.telegram.messenger.R.string.AddMember));
                        } else {
                            textCell.setText(LocaleController.getString("AddRecipient", xyz.telegram.messenger.R.string.AddRecipient));
                        }
                    }
                    break;
                case 4:
                    ...
                    if (part != null) {
                        ...
                        userCell.setData(MessagesController.getInstance().getUser(part.user_id), null, null, i == emptyRowChat2 + 1 ? xyz.telegram.messenger.R.drawable.menu_newgroup : 0);
                    }
                    break;
                case 8:
                    ...
                    if (i == userInfoRow) {
                        ...
                        aboutLinkCell.setTextAndIcon(about, xyz.telegram.messenger.R.drawable.bot_info);
                    } else if (i == channelInfoRow) {
                        String text = info.about;
                        while (text.contains("\n\n\n")) {
                            text = text.replace("\n\n\n", "\n\n");
                        }
                        aboutLinkCell.setTextAndIcon(text, xyz.telegram.messenger.R.drawable.bot_info);
                    }
                    break;
                default:
            ...
            if (checkBackground) {
                ...
                if (enabled) {
                    if (holder.itemView.getBackground() == null) {
                        holder.itemView.setBackgroundResource(xyz.telegram.messenger.R.drawable.list_selector);
                    }
                } else {
                    if (holder.itemView.getBackground() != null) {
