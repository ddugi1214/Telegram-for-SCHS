...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(xyz.telegram.messenger.R.drawable.list_selector);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                popupWindow.setAnimationStyle(xyz.telegram.messenger.R.style.PopupAnimation);
            }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, xyz.telegram.messenger.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(xyz.telegram.messenger.R.drawable.ic_close_white);
