...
package xyz.telegram.ui.ActionBar;
...
public class Theme {
    ...
    public static void loadRecources(Context context) {
        if (backgroundDrawableIn == null) {
            backgroundDrawableIn = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_in);
            backgroundDrawableInSelected = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_in_selected);
            backgroundDrawableOut = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_out);
            backgroundDrawableOutSelected = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_out_selected);
            backgroundMediaDrawableIn = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_in_photo);
            backgroundMediaDrawableInSelected = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_in_photo_selected);
            backgroundMediaDrawableOut = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_out_photo);
            backgroundMediaDrawableOutSelected = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_out_photo_selected);
            checkDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_check);
            halfCheckDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_halfcheck);
            clockDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_clock);
            checkMediaDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_check_w);
            halfCheckMediaDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_halfcheck_w);
            clockMediaDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_clock_photo);
            clockChannelDrawable[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_clock2);
            clockChannelDrawable[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_clock2_s);
            errorDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.msg_warning);
            timeBackgroundDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.phototime2_b);
            timeStickerBackgroundDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.phototime2);
            broadcastDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.broadcast3);
            broadcastMediaDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.broadcast4);
            systemDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.system);
            botLink = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_link);
            botInline = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_lines);

            viewsCountDrawable[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.post_views);
            viewsCountDrawable[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.post_views_s);
            viewsOutCountDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.post_viewsg);
            viewsMediaCountDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.post_views_w);

            fileStatesDrawable[0][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_g);
            fileStatesDrawable[0][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_g_s);
            fileStatesDrawable[1][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_g);
            fileStatesDrawable[1][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_g_s);
            fileStatesDrawable[2][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_load);
            fileStatesDrawable[2][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_load_s);
            fileStatesDrawable[3][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g);
            fileStatesDrawable[3][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_s);
            fileStatesDrawable[4][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_cancel);
            fileStatesDrawable[4][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_g_cancel_s);
            fileStatesDrawable[5][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_b);
            fileStatesDrawable[5][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.play_b_s);
            fileStatesDrawable[6][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_b);
            fileStatesDrawable[6][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.pause_b_s);
            fileStatesDrawable[7][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_load);
            fileStatesDrawable[7][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_load_s);
            fileStatesDrawable[8][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b);
            fileStatesDrawable[8][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_s);
            fileStatesDrawable[9][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_cancel);
            fileStatesDrawable[9][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.file_b_cancel_s);

            photoStatesDrawables[0][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload);
            photoStatesDrawables[0][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload_pressed);
            photoStatesDrawables[1][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel);
            photoStatesDrawables[1][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel_pressed);
            photoStatesDrawables[2][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photogif);
            photoStatesDrawables[2][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photogif_pressed);
            photoStatesDrawables[3][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.playvideo);
            photoStatesDrawables[3][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.playvideo_pressed);
            //photoStatesDrawables[4] = context.getResources().getDrawable(R.drawable.photopause);
            photoStatesDrawables[4][0] = photoStatesDrawables[4][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.burn);
            photoStatesDrawables[5][0] = photoStatesDrawables[5][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.circle);
            photoStatesDrawables[6][0] = photoStatesDrawables[6][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocheck);

            photoStatesDrawables[7][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload_g);
            photoStatesDrawables[7][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload_g_s);
            photoStatesDrawables[8][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel_g);
            photoStatesDrawables[8][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel_g_s);
            photoStatesDrawables[9][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_green);
            photoStatesDrawables[9][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_green);

            photoStatesDrawables[10][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload_b);
            photoStatesDrawables[10][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photoload_b_s);
            photoStatesDrawables[11][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel_b);
            photoStatesDrawables[11][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.photocancel_b_s);
            photoStatesDrawables[12][0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_blue);
            photoStatesDrawables[12][1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_blue_s);

            docMenuDrawable[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_actions_b);
            docMenuDrawable[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_actions_g);
            docMenuDrawable[2] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.doc_actions_b_s);
            docMenuDrawable[3] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.video_actions);

            contactDrawable[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.contact_blue);
            contactDrawable[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.contact_green);

            shareDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.share_round);
            shareIconDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.share_arrow);

            geoInDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.location_b);
            geoOutDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.location_g);

            cornerOuter[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_out_tl);
            cornerOuter[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_out_tr);
            cornerOuter[2] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_out_br);
            cornerOuter[3] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_out_bl);

            cornerInner[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_in_tr);
            cornerInner[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_in_tl);
            cornerInner[2] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_in_br);
            cornerInner[3] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.corner_in_bl);

            inlineDocDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_file);
            inlineAudioDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_music);
            inlineLocationDrawable = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.bot_location);
        }
    ...
    public static void loadChatResources(Context context) {
        if (attachButtonDrawables[0] == null) {
            attachButtonDrawables[0] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_camera_states);
            attachButtonDrawables[1] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_gallery_states);
            attachButtonDrawables[2] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_video_states);
            attachButtonDrawables[3] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_audio_states);
            attachButtonDrawables[4] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_file_states);
            attachButtonDrawables[5] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_contact_states);
            attachButtonDrawables[6] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_location_states);
            attachButtonDrawables[7] = context.getResources().getDrawable(xyz.telegram.messenger.R.drawable.attach_hide_states);
        }
    }
