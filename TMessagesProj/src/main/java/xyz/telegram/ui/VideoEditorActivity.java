...
import xyz.telegram.ui.Components.VideoSeekBarView;
import xyz.telegram.ui.Components.VideoTimelineView;
...
public class VideoEditorActivity extends BaseFragment implements TextureView.SurfaceTextureListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("EditVideo", xyz.telegram.messenger.R.string.EditVideo));
        ...
        menu.addItemWithWidth(1, xyz.telegram.messenger.R.drawable.ic_done, AndroidUtilities.dp(56));

        fragmentView = getParentActivity().getLayoutInflater().inflate(xyz.telegram.messenger.R.layout.video_editor_layout, null, false);
        originalSizeTextView = (TextView) fragmentView.findViewById(xyz.telegram.messenger.R.id.original_size);
        editedSizeTextView = (TextView) fragmentView.findViewById(xyz.telegram.messenger.R.id.edited_size);
        videoContainerView = fragmentView.findViewById(xyz.telegram.messenger.R.id.video_container);
        textContainerView = fragmentView.findViewById(xyz.telegram.messenger.R.id.info_container);
        controlView = fragmentView.findViewById(xyz.telegram.messenger.R.id.control_layout);
        compressVideo = (CheckBox) fragmentView.findViewById(xyz.telegram.messenger.R.id.compress_video);
        compressVideo.setText(LocaleController.getString("CompressVideo", xyz.telegram.messenger.R.string.CompressVideo));
        ...
        TextView titleTextView = (TextView) fragmentView.findViewById(xyz.telegram.messenger.R.id.original_title);
        titleTextView.setText(LocaleController.getString("OriginalVideo", xyz.telegram.messenger.R.string.OriginalVideo));
        titleTextView = (TextView) fragmentView.findViewById(xyz.telegram.messenger.R.id.edited_title);
        titleTextView.setText(LocaleController.getString("EditedVideo", xyz.telegram.messenger.R.string.EditedVideo));

        videoTimelineView = (VideoTimelineView) fragmentView.findViewById(xyz.telegram.messenger.R.id.video_timeline_view);
            ...
            public void onLeftProgressChanged(float progress) {
                ...
                try {
                    if (videoPlayer.isPlaying()) {
                        videoPlayer.pause();
                        playButton.setImageResource(xyz.telegram.messenger.R.drawable.video_play);
                    }
        ...
        videoSeekBarView = (VideoSeekBarView) fragmentView.findViewById(xyz.telegram.messenger.R.id.video_seekbar);
        ...
        playButton = (ImageView) fragmentView.findViewById(xyz.telegram.messenger.R.id.play_button);
        ...
        textureView = (TextureView) fragmentView.findViewById(xyz.telegram.messenger.R.id.video_view);
