...
import xyz.bluelemon.tfctalk.support.widget.helper.ItemTouchHelper;
...
import xyz.bluelemon.ui.Cells.StickerSetCell;
...
public class StickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("Stickers", xyz.bluelemon.tfctalk.R.string.Stickers));
        ...
        private void processSelectionOption(int which, TLRPC.TL_messages_stickerSet stickerSet) {
            if (which == 0) {
                ...
                try {
                    ...
                    getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", xyz.bluelemon.tfctalk.R.string.StickersShare)), 500);
                } catch (Exception e) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    view.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.list_selector_white);
                        ...
                        public void onClick(View v) {
                            ...
                            if (stickerSet.set.official) {
                                ...
                                items = new CharSequence[]{
                                        !stickerSet.set.disabled ? LocaleController.getString("StickersHide", xyz.bluelemon.tfctalk.R.string.StickersHide) : LocaleController.getString("StickersShow", xyz.bluelemon.tfctalk.R.string.StickersShow)
                                };
                            } else {
                                options = new int[]{0, 1, 2, 3};
                                items = new CharSequence[]{
                                        !stickerSet.set.disabled ? LocaleController.getString("StickersHide", xyz.bluelemon.tfctalk.R.string.StickersHide) : LocaleController.getString("StickersShow", xyz.bluelemon.tfctalk.R.string.StickersShow),
                                        LocaleController.getString("StickersRemove", xyz.bluelemon.tfctalk.R.string.StickersRemove),
                                        LocaleController.getString("StickersShare", xyz.bluelemon.tfctalk.R.string.StickersShare),
                                        LocaleController.getString("StickersCopy", xyz.bluelemon.tfctalk.R.string.StickersCopy),
                                };
                            }
                ...
                case 1:
                    ...
                    String text = LocaleController.getString("StickersInfo", xyz.bluelemon.tfctalk.R.string.StickersInfo);
