...
public class LanguageSelectActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("Language", xyz.bluelemon.tfctalk.R.string.Language));
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                builder.setMessage(LocaleController.getString("DeleteLocalization", xyz.bluelemon.tfctalk.R.string.DeleteLocalization));
                builder.setTitle(LocaleController.getString("AppName", xyz.bluelemon.tfctalk.R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Delete", xyz.bluelemon.tfctalk.R.string.Delete), new DialogInterface.OnClickListener() {
                    @Override
