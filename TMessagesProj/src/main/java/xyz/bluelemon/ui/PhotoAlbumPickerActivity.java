...
import xyz.bluelemon.ui.Cells.PhotoPickerAlbumsCell;
import xyz.bluelemon.ui.Cells.PhotoPickerSearchCell;
...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    selectedMode = 0;
                    dropDown.setText(LocaleController.getString("PickerPhotos", xyz.bluelemon.tfctalk.R.string.PickerPhotos));
                    ...
                    selectedMode = 1;
                    dropDown.setText(LocaleController.getString("PickerVideo", xyz.bluelemon.tfctalk.R.string.PickerVideo));
                    emptyView.setText(LocaleController.getString("NoVideo", xyz.bluelemon.tfctalk.R.string.NoVideo));
                    listAdapter.notifyDataSetChanged();
                }
            }
        });
        ...
        menu.addItem(1, xyz.bluelemon.tfctalk.R.drawable.ic_ab_other);
        ...
        if (!singlePhoto) {
            ...
            dropDownContainer.addSubItem(item_photos, LocaleController.getString("PickerPhotos", xyz.bluelemon.tfctalk.R.string.PickerPhotos), 0);
            dropDownContainer.addSubItem(item_video, LocaleController.getString("PickerVideo", xyz.bluelemon.tfctalk.R.string.PickerVideo), 0);
            ...
            actionBar.setTitle(LocaleController.getString("Gallery", xyz.bluelemon.tfctalk.R.string.Gallery));
        }
