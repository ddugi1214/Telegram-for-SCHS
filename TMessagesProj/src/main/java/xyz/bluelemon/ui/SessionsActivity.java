...
import xyz.bluelemon.ui.Cells.SessionCell;
...
public class SessionsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("SessionsTitle", xyz.bluelemon.tfctalk.R.string.SessionsTitle));
        ...
        emptyLayout.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.greydivider_bottom);
        ...
        imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.devices);
        ...
        textView.setText(LocaleController.getString("NoOtherSessions", xyz.bluelemon.tfctalk.R.string.NoOtherSessions));
        ...
        textView.setText(LocaleController.getString("NoOtherSessionsInfo", xyz.bluelemon.tfctalk.R.string.NoOtherSessionsInfo));
        emptyLayout.addView(textView);
        layoutParams2 = (LinearLayout.LayoutParams) textView.getLayoutParams();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == terminateAllSessionsRow) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureSessions", xyz.bluelemon.tfctalk.R.string.AreYouSureSessions));
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (error == null && response instanceof TLRPC.TL_boolTrue) {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("TerminateAllSessions", xyz.bluelemon.tfctalk.R.string.TerminateAllSessions), Toast.LENGTH_SHORT);
                                                toast.show();
                                            } else {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnknownError", xyz.bluelemon.tfctalk.R.string.UnknownError), Toast.LENGTH_SHORT);
                                                toast.show();
                                            }
                                            finishFragment();
                                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("TerminateSessionQuestion", xyz.bluelemon.tfctalk.R.string.TerminateSessionQuestion));
                    builder.setTitle(LocaleController.getString("AppName", xyz.bluelemon.tfctalk.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", xyz.bluelemon.tfctalk.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == terminateAllSessionsRow) {
                    ...
                    textCell.setText(LocaleController.getString("TerminateAllSessions", xyz.bluelemon.tfctalk.R.string.TerminateAllSessions), false);
                }
            } else if (type == 1) {
                if (view == null) {
                ...
                if (i == terminateAllSessionsDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ClearOtherSessionsHelp", xyz.bluelemon.tfctalk.R.string.ClearOtherSessionsHelp));
                    view.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.greydivider);
                } else if (i == otherSessionsTerminateDetail) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("TerminateSessionInfo", xyz.bluelemon.tfctalk.R.string.TerminateSessionInfo));
                ...
                if (i == currentSessionSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("CurrentSession", xyz.bluelemon.tfctalk.R.string.CurrentSession));
                } else if (i == otherSessionsSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("OtherSessions", xyz.bluelemon.tfctalk.R.string.OtherSessions));
                }
            } else if (type == 3) {
