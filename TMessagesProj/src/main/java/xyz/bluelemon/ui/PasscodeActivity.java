...
public class PasscodeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
        ...
        if (type != 0) {
            ...
            if (type == 1) {
                if (UserConfig.passcodeHash.length() != 0) {
                    titleTextView.setText(LocaleController.getString("EnterNewPasscode", xyz.bluelemon.tfctalk.R.string.EnterNewPasscode));
                } else {
                    titleTextView.setText(LocaleController.getString("EnterNewFirstPasscode", xyz.bluelemon.tfctalk.R.string.EnterNewFirstPasscode));
                }
            } else {
                titleTextView.setText(LocaleController.getString("EnterCurrentPasscode", xyz.bluelemon.tfctalk.R.string.EnterCurrentPasscode));
            }
            ...
            if (type == 1) {
                ...
                dropDownContainer.addSubItem(pin_item, LocaleController.getString("PasscodePIN", xyz.bluelemon.tfctalk.R.string.PasscodePIN), 0);
                dropDownContainer.addSubItem(password_item, LocaleController.getString("PasscodePassword", xyz.bluelemon.tfctalk.R.string.PasscodePassword), 0);
                ...
                actionBar.setTitle(LocaleController.getString("Passcode", xyz.bluelemon.tfctalk.R.string.Passcode));
            }
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    if (i == changePasscodeRow) {
                        ...
                        builder.setTitle(LocaleController.getString("AutoLock", xyz.bluelemon.tfctalk.R.string.AutoLock));
                        ...
                        numberPicker.setFormatter(new NumberPicker.Formatter() {
                            ...
                            public String format(int value) {
                                if (value == 0) {
                                    return LocaleController.getString("AutoLockDisabled", xyz.bluelemon.tfctalk.R.string.AutoLockDisabled);
                                } else if (value == 1) {
                                    return LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1));
                                } else if (value == 2) {
                                    return LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5));
                                } else if (value == 3) {
                                    return LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1));
                                } else if (value == 4) {
                                    return LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5));
                                }
                                return "";
                            }
                        });
    ...
    private void updateDropDownTextView() {
        if (dropDown != null) {
            if (currentPasswordType == 0) {
                dropDown.setText(LocaleController.getString("PasscodePIN", xyz.bluelemon.tfctalk.R.string.PasscodePIN));
            } else if (currentPasswordType == 1) {
                dropDown.setText(LocaleController.getString("PasscodePassword", xyz.bluelemon.tfctalk.R.string.PasscodePassword));
            }
        }
    ...
    private void processNext() {
        ...
        if (currentPasswordType == 0) {
            actionBar.setTitle(LocaleController.getString("PasscodePIN", xyz.bluelemon.tfctalk.R.string.PasscodePIN));
        } else {
            actionBar.setTitle(LocaleController.getString("PasscodePassword", xyz.bluelemon.tfctalk.R.string.PasscodePassword));
        }
        dropDownContainer.setVisibility(View.GONE);
        titleTextView.setText(LocaleController.getString("ReEnterYourPasscode", xyz.bluelemon.tfctalk.R.string.ReEnterYourPasscode));
    ...
    private void processDone() {
        ...
        if (type == 1) {
            if (!firstPassword.equals(passwordEditText.getText().toString())) {
                try {
                    Toast.makeText(getParentActivity(), LocaleController.getString("PasscodeDoNotMatch", xyz.bluelemon.tfctalk.R.string.PasscodeDoNotMatch), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    FileLog.e("tmessages", e);
                }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (viewType == 0) {
                ...
                if (i == passcodeRow) {
                    textCell.setTextAndCheck(LocaleController.getString("Passcode", xyz.bluelemon.tfctalk.R.string.Passcode), UserConfig.passcodeHash.length() > 0, true);
                } else if (i == fingerprintRow) {
                    textCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", xyz.bluelemon.tfctalk.R.string.UnlockFingerprint), UserConfig.useFingerprint, true);
                }
            } else if (viewType == 1) {
                if (view == null) {
                ...
                if (i == changePasscodeRow) {
                    textCell.setText(LocaleController.getString("ChangePasscode", xyz.bluelemon.tfctalk.R.string.ChangePasscode), false);
                    textCell.setTextColor(UserConfig.passcodeHash.length() == 0 ? 0xffc6c6c6 : 0xff000000);
                } else if (i == autoLockRow) {
                    String val;
                    if (UserConfig.autoLockIn == 0) {
                        val = LocaleController.formatString("AutoLockDisabled", xyz.bluelemon.tfctalk.R.string.AutoLockDisabled);
                    } else if (UserConfig.autoLockIn < 60 * 60) {
                        val = LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", UserConfig.autoLockIn / 60));
                    } else if (UserConfig.autoLockIn < 60 * 60 * 24) {
                        val = LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil(UserConfig.autoLockIn / 60.0f / 60)));
                    } else {
                        val = LocaleController.formatString("AutoLockInTime", xyz.bluelemon.tfctalk.R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(UserConfig.autoLockIn / 60.0f / 60 / 24)));
                    }
                    textCell.setTextAndValue(LocaleController.getString("AutoLock", xyz.bluelemon.tfctalk.R.string.AutoLock), val, true);
                ...
                if (i == passcodeDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ChangePasscodeInfo", xyz.bluelemon.tfctalk.R.string.ChangePasscodeInfo));
                    ...
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("AutoLockInfo", xyz.bluelemon.tfctalk.R.string.AutoLockInfo));
                    view.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.greydivider_bottom);
                }
            }
            return view;
