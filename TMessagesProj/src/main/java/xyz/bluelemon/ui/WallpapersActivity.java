...
import xyz.bluelemon.ui.Cells.WallpaperCell;
...
public class WallpapersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ChatBackground", xyz.bluelemon.tfctalk.R.string.ChatBackground));
        ...
        progressViewBackground.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.system_loader);
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (position == 0) {
                    ...
                    CharSequence[] items = new CharSequence[]{LocaleController.getString("FromCamera", xyz.bluelemon.tfctalk.R.string.FromCamera), LocaleController.getString("FromGalley", xyz.bluelemon.tfctalk.R.string.FromGalley), LocaleController.getString("Cancel", xyz.bluelemon.tfctalk.R.string.Cancel)};
    ...
    private void processSelectedBackground() {
        ...
        if (selectedBackground != -1 && selectedBackground != 1000001 && wallPaper != null && wallPaper instanceof TLRPC.TL_wallPaper) {
            ...
            if (selectedBackground == 1000001) {
                backgroundImage.setImageResource(xyz.bluelemon.tfctalk.R.drawable.background_hd);
                backgroundImage.setBackgroundColor(0);
                selectedColor = 0;
