...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (isAlwaysShare) {
            if (isGroup) {
                actionBar.setTitle(LocaleController.getString("AlwaysAllow", xyz.bluelemon.tfctalk.R.string.AlwaysAllow));
            } else {
                actionBar.setTitle(LocaleController.getString("AlwaysShareWithTitle", xyz.bluelemon.tfctalk.R.string.AlwaysShareWithTitle));
            }
        } else if (isNeverShare) {
            if (isGroup) {
                actionBar.setTitle(LocaleController.getString("NeverAllow", xyz.bluelemon.tfctalk.R.string.NeverAllow));
            } else {
                actionBar.setTitle(LocaleController.getString("NeverShareWithTitle", xyz.bluelemon.tfctalk.R.string.NeverShareWithTitle));
            }
        } else {
            actionBar.setTitle(chatType == ChatObject.CHAT_TYPE_CHAT ? LocaleController.getString("NewGroup", xyz.bluelemon.tfctalk.R.string.NewGroup) : LocaleController.getString("NewBroadcastList", xyz.bluelemon.tfctalk.R.string.NewBroadcastList));
            actionBar.setSubtitle(LocaleController.formatString("MembersCount", xyz.bluelemon.tfctalk.R.string.MembersCount, selectedContacts.size(), maxCount));
        }
        ...
        if (isAlwaysShare) {
            if (isGroup) {
                userSelectEditText.setHint(LocaleController.getString("AlwaysAllowPlaceholder", xyz.bluelemon.tfctalk.R.string.AlwaysAllowPlaceholder));
            } else {
                userSelectEditText.setHint(LocaleController.getString("AlwaysShareWithPlaceholder", xyz.bluelemon.tfctalk.R.string.AlwaysShareWithPlaceholder));
            }
        } else if (isNeverShare) {
            if (isGroup) {
                userSelectEditText.setHint(LocaleController.getString("NeverAllowPlaceholder", xyz.bluelemon.tfctalk.R.string.NeverAllowPlaceholder));
            } else {
                userSelectEditText.setHint(LocaleController.getString("NeverShareWithPlaceholder", xyz.bluelemon.tfctalk.R.string.NeverShareWithPlaceholder));
            }
        } else {
            userSelectEditText.setHint(LocaleController.getString("SendMessageTo", xyz.bluelemon.tfctalk.R.string.SendMessageTo));
        }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (selectedContacts.containsKey(user.id)) {
                    ...
                    if (chatType == ChatObject.CHAT_TYPE_CHAT && selectedContacts.size() == MessagesController.getInstance().maxGroupCount - 1) {
                        ...
                        builder.setMessage(LocaleController.getString("SoftUserLimitAlert", xyz.bluelemon.tfctalk.R.string.SoftUserLimitAlert));
