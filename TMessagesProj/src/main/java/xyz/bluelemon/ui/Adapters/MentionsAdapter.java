...
import xyz.bluelemon.ui.Cells.BotSwitchCell;
import xyz.bluelemon.ui.Cells.ContextLinkCell;
import xyz.bluelemon.ui.Cells.MentionCell;
                                            ...
                                            if (user.bot && user.bot_inline_placeholder != null) {
                                                ...
                                                if (foundContextBot.bot_inline_geo) {
                                                    ...
                                                    if (!allowGeo && parentFragment != null && parentFragment.getParentActivity() != null) {
                                                        ...
                                                        builder.setMessage(LocaleController.getString("ShareYouLocationInline", xyz.bluelemon.tfctalk.R.string.ShareYouLocationInline));
                                                        ...
                                                        builder.setNegativeButton(LocaleController.getString("Cancel", xyz.bluelemon.tfctalk.R.string.Cancel), new DialogInterface.OnClickListener() {
                                                            @Override
