...
import xyz.bluelemon.ui.Cells.LetterSectionCell;
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 4) {
            ...
            if (convertView == null) {
                ...
                ((GreySectionCell) convertView).setText(LocaleController.getString("Contacts", xyz.bluelemon.tfctalk.R.string.Contacts).toUpperCase());
            }
        } else if (type == 2) {
            if (convertView == null) {
            ...
            if (needPhonebook) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("InviteToGroupByLink", xyz.bluelemon.tfctalk.R.string.InviteToGroupByLink), xyz.bluelemon.tfctalk.R.drawable.menu_invite);
            } else {
                if (position == 0) {
