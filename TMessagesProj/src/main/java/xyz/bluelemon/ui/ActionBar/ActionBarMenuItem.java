...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.list_selector);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                popupWindow.setAnimationStyle(xyz.bluelemon.tfctalk.R.style.PopupAnimation);
            }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, xyz.bluelemon.tfctalk.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(xyz.bluelemon.tfctalk.R.drawable.ic_close_white);
