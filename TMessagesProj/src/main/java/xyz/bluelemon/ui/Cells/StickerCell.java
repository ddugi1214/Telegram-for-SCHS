...
public class StickerCell extends FrameLayout {
    ...
    public void setSticker(TLRPC.Document document, int side) {
        ...
        sticker = document;
        if (side == -1) {
            setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.stickers_back_left);
            setPadding(AndroidUtilities.dp(7), 0, 0, 0);
        } else if (side == 0) {
            setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.stickers_back_center);
            setPadding(0, 0, 0, 0);
        } else if (side == 1) {
            setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.stickers_back_right);
            setPadding(0, 0, AndroidUtilities.dp(7), 0);
        } else if (side == 2) {
            setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.stickers_back_all);
