...
import xyz.bluelemon.ui.Components.LineProgressView;
...
public class SharedDocumentCell extends FrameLayout implements MediaController.FileDownloadProgressListener {
    ...
    private int icons[] = {
            xyz.bluelemon.tfctalk.R.drawable.media_doc_blue,
            xyz.bluelemon.tfctalk.R.drawable.media_doc_green,
            xyz.bluelemon.tfctalk.R.drawable.media_doc_red,
            xyz.bluelemon.tfctalk.R.drawable.media_doc_yellow
    };
    ...
    public SharedDocumentCell(Context context) {
        ...
        checkBox = new CheckBox(context, xyz.bluelemon.tfctalk.R.drawable.round_check2);
    ...
    public void setDocument(MessageObject messageObject, boolean divider) {
        ...
        if (messageObject != null && messageObject.getDocument() != null) {
            ...
            dateTextView.setText(String.format("%s, %s", AndroidUtilities.formatFileSize(messageObject.getDocument().size), LocaleController.formatString("formatDateAtTime", xyz.bluelemon.tfctalk.R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(date)), LocaleController.getInstance().formatterDay.format(new Date(date)))));
        } else {
    ...
    public void updateFileExistIcon() {
        if (message != null && message.messageOwner.media != null) {
            ...
            if (fileName == null) {
                ...
                statusImageView.setImageResource(loading ? xyz.bluelemon.tfctalk.R.drawable.media_doc_pause : xyz.bluelemon.tfctalk.R.drawable.media_doc_load);
