...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context) {
        ...
        checkBox = new CheckBox(context, xyz.bluelemon.tfctalk.R.drawable.checkbig);
        checkBox.setSize(30);
    ...
    public void setPhotoEntry(MediaController.PhotoEntry entry, boolean last) {
        ...
        if (photoEntry.thumbPath != null) {
            imageView.setImage(photoEntry.thumbPath, null, getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.nophotos));
        } else if (photoEntry.path != null) {
            imageView.setOrientation(photoEntry.orientation, true);
            imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.nophotos));
        } else {
