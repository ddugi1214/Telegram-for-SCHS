...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    public PhotoPickerSearchCell(Context context, boolean allowGifs) {
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchImages", xyz.bluelemon.tfctalk.R.string.SearchImages));
        searchButton.textView2.setText(LocaleController.getString("SearchImagesInfo", xyz.bluelemon.tfctalk.R.string.SearchImagesInfo));
        searchButton.imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.search_web);
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchGifs", xyz.bluelemon.tfctalk.R.string.SearchGifs));
        searchButton.textView2.setText("GIPHY");
        searchButton.imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.search_gif);
        addView(searchButton);
