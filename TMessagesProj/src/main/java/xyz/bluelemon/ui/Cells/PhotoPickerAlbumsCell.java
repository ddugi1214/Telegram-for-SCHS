...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            selector.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.list_selector);
        ...
        if (albumEntry != null) {
            ...
            if (albumEntry.coverPhoto != null && albumEntry.coverPhoto.path != null) {
                ...
                if (albumEntry.coverPhoto.isVideo) {
                    albumView.imageView.setImage("vthumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.nophotos));
                } else {
                    albumView.imageView.setImage("thumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.nophotos));
                }
            } else {
                albumView.imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.nophotos);
            }
