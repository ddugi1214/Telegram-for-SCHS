...
public class StickersAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickersAlert(Context context, TLRPC.InputStickerSet set, TLRPC.TL_messages_stickerSet loadedSet, StickersAlertDelegate stickersAlertDelegate) {
        ...
        shadow[0].setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.header_shadow);
        ...
        shadow[1].setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.header_shadow_reverse);
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Close", xyz.bluelemon.tfctalk.R.string.Close).toUpperCase());
        ...
        pickerBottomLayout.doneButtonBadgeTextView.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.stickercounter);
        ...
        closeButton.setImageResource(xyz.bluelemon.tfctalk.R.drawable.delete_reply);
        ...
        previewSendButton.setText(LocaleController.getString("Close", xyz.bluelemon.tfctalk.R.string.Close).toUpperCase());
        ...
        previewSendButtonShadow.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.header_shadow_reverse);
        ...
        if (delegate != null) {
            previewSendButton.setText(LocaleController.getString("SendSticker", xyz.bluelemon.tfctalk.R.string.SendSticker).toUpperCase());
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                Toast.makeText(getContext(), LocaleController.getString("AddStickersNotFound", xyz.bluelemon.tfctalk.R.string.AddStickersNotFound), Toast.LENGTH_SHORT).show();
                                dismiss();
                            }
                        }
                    });
    ...
    private void updateFields() {
        ...
        if (stickerSet != null) {
            ...
            if (stickerSet.set == null || !StickersQuery.isStickerPackInstalled(stickerSet.set.id)) {
                            ...
                            public void run(TLObject response, final TLRPC.TL_error error) {
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            if (error == null) {
                                                Toast.makeText(getContext(), LocaleController.getString("AddStickersInstalled", xyz.bluelemon.tfctalk.R.string.AddStickersInstalled), Toast.LENGTH_SHORT).show();
                                            } else {
                                                if (error.text.equals("STICKERSETS_TOO_MUCH")) {
                                                    Toast.makeText(getContext(), LocaleController.getString("TooMuchStickersets", xyz.bluelemon.tfctalk.R.string.TooMuchStickersets), Toast.LENGTH_SHORT).show();
                                                } else {
                                                    Toast.makeText(getContext(), LocaleController.getString("ErrorOccurred", xyz.bluelemon.tfctalk.R.string.ErrorOccurred), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        } catch (Exception e) {
                ...
                }, LocaleController.getString("AddStickers", xyz.bluelemon.tfctalk.R.string.AddStickers), Theme.STICKERS_SHEET_ADD_TEXT_COLOR, true);
            } else {
                if (stickerSet.set.official) {
                    ...
                    }, LocaleController.getString("StickersRemove", xyz.bluelemon.tfctalk.R.string.StickersRemove), Theme.STICKERS_SHEET_REMOVE_TEXT_COLOR, false);
                }
            }
            adapter.notifyDataSetChanged();
        } else {
