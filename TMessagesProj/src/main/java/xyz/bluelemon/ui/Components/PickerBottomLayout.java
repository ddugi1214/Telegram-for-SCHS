...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        cancelButton.setText(LocaleController.getString("Cancel", xyz.bluelemon.tfctalk.R.string.Cancel).toUpperCase());
        ...
        doneButtonBadgeTextView.setBackgroundResource(isDarkTheme ? xyz.bluelemon.tfctalk.R.drawable.photobadge : xyz.bluelemon.tfctalk.R.drawable.bluecounter);
