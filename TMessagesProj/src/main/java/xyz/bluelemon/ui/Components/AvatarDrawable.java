...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable() {
        ...
        if (namePaint == null) {
            ...
            broadcastDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.broadcast_w);
        }
    }
    ...
    public void setDrawPhoto(boolean value) {
        if (value && photoDrawable == null) {
            photoDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.photo_w);
        }
        drawPhoto = value;
    }
