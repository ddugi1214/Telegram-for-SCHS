...
public class PasscodeView extends FrameLayout {
    ...
    public PasscodeView(final Context context) {
        ...
        imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.passcode_logo);
        ...
        checkImage.setImageResource(xyz.bluelemon.tfctalk.R.drawable.passcode_check);
        checkImage.setScaleType(ImageView.ScaleType.CENTER);
        checkImage.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.bar_selector_lock);
        ...
        eraseView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.passcode_delete);
        ...
        for (int a = 0; a < 11; a++) {
            ...
            frameLayout.setBackgroundResource(xyz.bluelemon.tfctalk.R.drawable.bar_selector_lock);
        ...
        if (Build.VERSION.SDK_INT >= 23 && parentActivity != null && UserConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    fingerprintTextView.setText(LocaleController.getString("FingerprintInfo", xyz.bluelemon.tfctalk.R.string.FingerprintInfo));
                    ...
                    fingerprintImageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.ic_fp_40px);
                    ...
                    fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", xyz.bluelemon.tfctalk.R.string.FingerprintHelp));
                    ...
                    fingerprintManager.authenticate(null, 0, cancellationSignal, new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            showFingerprintError(LocaleController.getString("FingerprintNotRecognized", xyz.bluelemon.tfctalk.R.string.FingerprintNotRecognized));
                        }
    ...
    public void onShow() {
        ...
        passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", xyz.bluelemon.tfctalk.R.string.EnterYourPasscode));
    ...
    private void showFingerprintError(CharSequence error) {
        fingerprintImageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.ic_fingerprint_error);
