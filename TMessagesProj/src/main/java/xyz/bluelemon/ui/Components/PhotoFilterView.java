...
package xyz.bluelemon.ui.Components;
...
import xyz.bluelemon.tfctalk.DispatchQueue;
...
import xyz.bluelemon.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setText(LocaleController.getString("Cancel", xyz.bluelemon.tfctalk.R.string.Cancel).toUpperCase());
        ...
        doneTextView.setText(LocaleController.getString("Done", xyz.bluelemon.tfctalk.R.string.Done).toUpperCase());
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == enhanceTool) {
                    ...
                    paramTextView.setText(LocaleController.getString("Enhance", xyz.bluelemon.tfctalk.R.string.Enhance));
                } else if (position == highlightsTool) {
                    previousValue = highlightsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Highlights", xyz.bluelemon.tfctalk.R.string.Highlights));
                } else if (position == contrastTool) {
                    previousValue = contrastValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Contrast", xyz.bluelemon.tfctalk.R.string.Contrast));
                } else if (position == exposureTool) {
                    previousValue = exposureValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Exposure", xyz.bluelemon.tfctalk.R.string.Exposure));
                } else if (position == warmthTool) {
                    previousValue = warmthValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Warmth", xyz.bluelemon.tfctalk.R.string.Warmth));
                } else if (position == saturationTool) {
                    previousValue = saturationValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Saturation", xyz.bluelemon.tfctalk.R.string.Saturation));
                } else if (position == vignetteTool) {
                    previousValue = vignetteValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Vignette", xyz.bluelemon.tfctalk.R.string.Vignette));
                } else if (position == shadowsTool) {
                    previousValue = shadowsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Shadows", xyz.bluelemon.tfctalk.R.string.Shadows));
                } else if (position == grainTool) {
                    previousValue = grainValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Grain", xyz.bluelemon.tfctalk.R.string.Grain));
                } else if (position == fadeTool) {
                    previousValue = fadeValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Fade", xyz.bluelemon.tfctalk.R.string.Fade));
                } else if (position == sharpenTool) {
                    previousValue = sharpenValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Sharpen", xyz.bluelemon.tfctalk.R.string.Sharpen));
        ...
        imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.edit_cancel);
        ...
        imageView.setImageResource(xyz.bluelemon.tfctalk.R.drawable.edit_doneblue);
        imageView.setBackgroundDrawable(Theme.createBarSelectorDrawable(Theme.ACTION_BAR_PICKER_SELECTOR_COLOR, false));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            if (a == 0) {
                curveTextView[a].setText(LocaleController.getString("CurvesAll", xyz.bluelemon.tfctalk.R.string.CurvesAll).toUpperCase());
            } else if (a == 1) {
                curveTextView[a].setText(LocaleController.getString("CurvesRed", xyz.bluelemon.tfctalk.R.string.CurvesRed).toUpperCase());
            } else if (a == 2) {
                curveTextView[a].setText(LocaleController.getString("CurvesGreen", xyz.bluelemon.tfctalk.R.string.CurvesGreen).toUpperCase());
            } else if (a == 3) {
                curveTextView[a].setText(LocaleController.getString("CurvesBlue", xyz.bluelemon.tfctalk.R.string.CurvesBlue).toUpperCase());
            }
        ...
        tintShadowsButton.setText(LocaleController.getString("TintShadows", xyz.bluelemon.tfctalk.R.string.TintShadows).toUpperCase());
        ...
        tintHighlightsButton.setText(LocaleController.getString("TintHighlights", xyz.bluelemon.tfctalk.R.string.TintHighlights).toUpperCase());
        ...
        blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_off_active, 0, 0);
        ...
        blurOffButton.setText(LocaleController.getString("BlurOff", xyz.bluelemon.tfctalk.R.string.BlurOff));
        ...
        blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_radial, 0, 0);
        ...
        blurRadialButton.setText(LocaleController.getString("BlurRadial", xyz.bluelemon.tfctalk.R.string.BlurRadial));
        ...
        blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_linear, 0, 0);
        ...
        blurLinearButton.setText(LocaleController.getString("BlurLinear", xyz.bluelemon.tfctalk.R.string.BlurLinear));
    ...
    private void updateSelectedBlurType() {
        if (blurType == 0) {
            ...
            blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_off, 0, 0);
            blurOffButton.setTextColor(0xffffffff);
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_radial_active, 0, 0);
            ...
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_radial, 0, 0);
            blurRadialButton.setTextColor(0xffffffff);
            blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, xyz.bluelemon.tfctalk.R.drawable.blur_linear_active, 0, 0);
        ...
        if (editView.getVisibility() == GONE) {
            ...
            if (selectedTool == blurTool || selectedTool == tintTool || selectedTool == curvesTool) {
                ...
                if (selectedTool == blurTool) {
                    infoTextView.setText(LocaleController.getString("Blur", xyz.bluelemon.tfctalk.R.string.Blur));
                    if (blurType != 0) {
                        blurControl.setVisibility(VISIBLE);
                    }
                } else if (selectedTool == curvesTool) {
                    infoTextView.setText(LocaleController.getString("Curves", xyz.bluelemon.tfctalk.R.string.Curves));
                    ...
                    infoTextView.setText(LocaleController.getString("Tint", xyz.bluelemon.tfctalk.R.string.Tint));
                }
    ...
    public class ToolsAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == enhanceTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_enhance, LocaleController.getString("Enhance", xyz.bluelemon.tfctalk.R.string.Enhance), enhanceValue);
            } else if (i == highlightsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_highlights, LocaleController.getString("Highlights", xyz.bluelemon.tfctalk.R.string.Highlights), highlightsValue);
            } else if (i == contrastTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_contrast, LocaleController.getString("Contrast", xyz.bluelemon.tfctalk.R.string.Contrast), contrastValue);
            } else if (i == exposureTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_brightness, LocaleController.getString("Exposure", xyz.bluelemon.tfctalk.R.string.Exposure), exposureValue);
            } else if (i == warmthTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_warmth, LocaleController.getString("Warmth", xyz.bluelemon.tfctalk.R.string.Warmth), warmthValue);
            } else if (i == saturationTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_saturation, LocaleController.getString("Saturation", xyz.bluelemon.tfctalk.R.string.Saturation), saturationValue);
            } else if (i == vignetteTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_vignette, LocaleController.getString("Vignette", xyz.bluelemon.tfctalk.R.string.Vignette), vignetteValue);
            } else if (i == shadowsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_shadows, LocaleController.getString("Shadows", xyz.bluelemon.tfctalk.R.string.Shadows), shadowsValue);
            } else if (i == grainTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_grain, LocaleController.getString("Grain", xyz.bluelemon.tfctalk.R.string.Grain), grainValue);
            } else if (i == sharpenTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_details, LocaleController.getString("Sharpen", xyz.bluelemon.tfctalk.R.string.Sharpen), sharpenValue);
            } else if (i == tintTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_tint, LocaleController.getString("Tint", xyz.bluelemon.tfctalk.R.string.Tint), tintHighlightsColor != 0 || tintShadowsColor != 0 ? "◆" : "");
            } else if (i == fadeTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_fade, LocaleController.getString("Fade", xyz.bluelemon.tfctalk.R.string.Fade), fadeValue);
            } else if (i == curvesTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_curve, LocaleController.getString("Curves", xyz.bluelemon.tfctalk.R.string.Curves), curvesToolValue.shouldBeSkipped() ? "" : "◆");
            } else if (i == blurTool) {
                String value = "";
                if (blurType == 1) {
                    value = "R";
                ...
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(xyz.bluelemon.tfctalk.R.drawable.tool_blur, LocaleController.getString("Blur", xyz.bluelemon.tfctalk.R.string.Blur), value);
            }
        }
    }
}
