...
public class TimerDrawable extends Drawable {
    ...
    public TimerDrawable(Context context) {
        if (emptyTimerDrawable == null) {
            emptyTimerDrawable = context.getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.header_timer);
            timerDrawable = context.getResources().getDrawable(xyz.bluelemon.tfctalk.R.drawable.header_timer2);
