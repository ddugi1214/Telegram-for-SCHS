...
import xyz.bluelemon.ui.Components.VideoSeekBarView;
import xyz.bluelemon.ui.Components.VideoTimelineView;
...
public class VideoEditorActivity extends BaseFragment implements TextureView.SurfaceTextureListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("EditVideo", xyz.bluelemon.tfctalk.R.string.EditVideo));
        ...
        menu.addItemWithWidth(1, xyz.bluelemon.tfctalk.R.drawable.ic_done, AndroidUtilities.dp(56));

        fragmentView = getParentActivity().getLayoutInflater().inflate(xyz.bluelemon.tfctalk.R.layout.video_editor_layout, null, false);
        originalSizeTextView = (TextView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.original_size);
        editedSizeTextView = (TextView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.edited_size);
        videoContainerView = fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.video_container);
        textContainerView = fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.info_container);
        controlView = fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.control_layout);
        compressVideo = (CheckBox) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.compress_video);
        compressVideo.setText(LocaleController.getString("CompressVideo", xyz.bluelemon.tfctalk.R.string.CompressVideo));
        ...
        TextView titleTextView = (TextView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.original_title);
        titleTextView.setText(LocaleController.getString("OriginalVideo", xyz.bluelemon.tfctalk.R.string.OriginalVideo));
        titleTextView = (TextView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.edited_title);
        titleTextView.setText(LocaleController.getString("EditedVideo", xyz.bluelemon.tfctalk.R.string.EditedVideo));

        videoTimelineView = (VideoTimelineView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.video_timeline_view);
            ...
            public void onLeftProgressChanged(float progress) {
                ...
                try {
                    if (videoPlayer.isPlaying()) {
                        videoPlayer.pause();
                        playButton.setImageResource(xyz.bluelemon.tfctalk.R.drawable.video_play);
                    }
        ...
        videoSeekBarView = (VideoSeekBarView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.video_seekbar);
        ...
        playButton = (ImageView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.play_button);
        ...
        textureView = (TextureView) fragmentView.findViewById(xyz.bluelemon.tfctalk.R.id.video_view);
