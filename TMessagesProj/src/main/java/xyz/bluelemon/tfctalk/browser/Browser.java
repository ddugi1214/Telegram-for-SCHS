...
package xyz.bluelemon.tfctalk.browser;
...
import xyz.bluelemon.tfctalk.ShareBroadcastReceiver;
import xyz.bluelemon.tfctalk.support.customtabs.CustomTabsCallback;
import xyz.bluelemon.tfctalk.support.customtabs.CustomTabsClient;
import xyz.bluelemon.tfctalk.support.customtabs.CustomTabsIntent;
import xyz.bluelemon.tfctalk.support.customtabs.CustomTabsServiceConnection;
import xyz.bluelemon.tfctalk.support.customtabs.CustomTabsSession;
import xyz.bluelemon.tfctalk.support.customtabsclient.shared.CustomTabsHelper;
import xyz.bluelemon.tfctalk.support.customtabsclient.shared.ServiceConnection;
import xyz.bluelemon.tfctalk.support.customtabsclient.shared.ServiceConnectionCallback;
import xyz.bluelemon.ui.ActionBar.Theme;
import xyz.bluelemon.ui.LaunchActivity;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri) {
                ...
                builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), xyz.bluelemon.tfctalk.R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", xyz.bluelemon.tfctalk.R.string.ShareFile), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, share, 0), false);
